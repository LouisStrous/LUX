...
internalRoutine function[] = {
 ...
 { "CALENDAR",	1, 1, ana_calendar, /* astron.c */
  ...
  { "FIT",	3, 16, ana_generalfit, /* fit.c */
  "|4|::START:STEP:LOWBOUND:HIGHBOUND:WEIGHTS:QTHRESH:PTHRESH:ITHRESH:DTHRESH:FAC:NITER:NSAME:ERR:FIT:1VOCAL:4DOWN:8PCHI:16GAUSSIANS:32POWERFUNC:64ONEBYONE" },
#if DEVELOP
