...
void sprint_time (char *out, TIME t, char const* zone, int32_t precision)
 ...
 //--------------------------------------------------------------------------
int32_t lux_tai_from_date(ArgumentCount narg, Symbol ps[]) // returns TAI
 ...
 //--------------------------------------------------------------------------
int32_t lux_date_from_tai(ArgumentCount narg, Symbol ps[]) // returns date string
 ...
 //--------------------------------------------------------------------------
int32_t lux_tri_name_from_tai(ArgumentCount narg, Symbol ps[]) // returns date string
...
int32_t lux_sun_b(ArgumentCount narg, Symbol ps[])// sun_b function
 // returns solar B angle, b = sun_b(day_of_year, year)
{
 ...
 //--------------------------------------------------------------------------
int32_t lux_sun_r(ArgumentCount narg, Symbol ps[]) // sun_r function
 ...
 //--------------------------------------------------------------------------
int32_t lux_sun_d(ArgumentCount narg, Symbol ps[]) // sun_d function
 ...
 //--------------------------------------------------------------------------
int32_t lux_sun_p(ArgumentCount narg, Symbol ps[]) // sun_p function
...
int32_t ephem_setup(ArgumentCount narg, Symbol ps[])
 {
