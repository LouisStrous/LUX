     ...
     // multiplication with array operands
{
  ...
  case LUX_INT16:
    ...
    case LUX_CFLOAT:
      while (nRepeat--) {
        re.f = *lp.w * rp.cf->real;
        im.f = *lp.w++ * rp.cf++->imaginary;
        tp.cf->real = re.f;
        tp.cf++->imaginary = im.f;
      }
      break;
    case LUX_CDOUBLE:
      while (nRepeat--) {
        re.d = *lp.w * rp.cd->real;
        im.d = *lp.w++ * rp.cd++->imaginary;
        tp.cd->real = re.d;
        tp.cd++->imaginary = im.d;
      }
      break;
  ...
  case LUX_INT16:
    ...
    case LUX_CFLOAT:
      while (nRepeat--) {
        d.f = rp.cf->real*rp.cf->real + rp.cf->imaginary*rp.cf->imaginary;
        d.f = 1.0/d.f;
        re.f = (*lp.w * rp.cf->real)*d.f;
        im.f = (-*lp.w++ * rp.cf++->imaginary)*d.f;
        tp.cf->real = re.f;
        tp.cf++->imaginary = im.f;
      }
      break;
    case LUX_CDOUBLE:
      while (nRepeat--) {
        d.d = rp.cd->real*rp.cd->real + rp.cd->imaginary*rp.cd->imaginary;
        d.d = 1.0/d.d;
        re.d = (*lp.w * rp.cd->real)*d.d;
        im.d = (-*lp.w++ * rp.cd++->imaginary)*d.d;
        tp.cd->real = re.d;
        tp.cd++->imaginary = im.d;
      }
      break;
...
//   5 NaN  NaN
{
  ...
  case LUX_INT8:
    ...
    case LUX_INT16:
      while (nRepeat--)
        *tp.w++ = ((value1.w = *lp.ui8++) > (value2.w = *rp.w++))?
          value1.w:
          value2.w;
          break;
    case LUX_INT32:
  ...
  case LUX_INT16:
    ...
    case LUX_INT8:
      while (nRepeat--)
        *tp.w++ = ((value1.w = *lp.w++) > (value2.w = *rp.ui8++))?
          value1.w:
          value2.w;
          break;
    case LUX_INT16:
            ...
            case LUX_RANGE:     // subscripts
              if (modified) {   // not the original symbol anymore
                ...
                for (j = 0; j <= depth; j++) {
                  ...
                  tptr[j].ptr.w = (int16_t*) malloc(tptr[j].number*sizeof(int16_t));
                  if (!tptr[j].ptr.w)
                    return cerror(ALLOC_ERR, 0);
            ...
            case LUX_RANGE:
              ...
              switch (symbol_class(result)) {
                ...
                case LUX_ARRAY:
                  ...
                  q.w = clist_symbols(target) = (int16_t*) malloc(symbol_memory(target));
                  if (!q.w)
