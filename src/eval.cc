     ...
     // power-taking with two array operands
{
  ...
  case LUX_INT8:
    ...
    case LUX_INT32:
      while (nRepeat--)
        *tp.f++ = pow(*lp.ui8++, *rp.l++);
      break;
    case LUX_INT64:
      while (nRepeat--)
        *tp.d++ = pow(*lp.ui8++, *rp.q++);
      break;
    case LUX_FLOAT:
      while (nRepeat--)
  ...
  case LUX_INT16:
    ...
    case LUX_INT32:
      while (nRepeat--)
        *tp.f++ = pow(*lp.i16++, *rp.l++);
      break;
    case LUX_INT64:
      while (nRepeat--)
        *tp.d++ = pow(*lp.i16++, *rp.q++);
      break;
    case LUX_FLOAT:
      while (nRepeat--)
  ...
  case LUX_INT32:
    ...
    case LUX_INT8:
      while (nRepeat--)
        *tp.f++ = pow(*lp.l++, *rp.ui8++);
      break;
    case LUX_INT16:
      while (nRepeat--)
        *tp.f++ = pow(*lp.l++, *rp.i16++);
      break;
    case LUX_INT32:
      while (nRepeat--)
        *tp.f++ = pow(*lp.l++, *rp.l++);
  ...
  case LUX_INT64:
    ...
    case LUX_INT8:
      while (nRepeat--)
        *tp.d++ = pow(*lp.q++, *rp.ui8++);
      break;
    case LUX_INT16:
      while (nRepeat--)
        *tp.d++ = pow(*lp.q++, *rp.i16++);
      break;
    case LUX_INT32:
      while (nRepeat--)
        *tp.d++ = pow(*lp.q++, *rp.l++);
     ...
     // subtraction with array operands
{
  ...
  case LUX_INT64:
    ...
    case LUX_INT8:
      while (nRepeat--)
        *tp.q++ = *lp.q++ - (int64_t) *rp.ui8++;
      break;
    case LUX_INT16:
      while (nRepeat--)
        *tp.q++ = *lp.q++ - (int64_t) *rp.i16++;
      break;
    case LUX_INT32:
      while (nRepeat--)
        *tp.q++ = *lp.q++ - *rp.l++;
     ...
     // multiplication with array operands
{
  ...
  case LUX_INT32:
    ...
    case LUX_CFLOAT:
      while (nRepeat--) {
        re.f = *lp.l * rp.cf->real;
        im.f = *lp.l++ * rp.cf++->imaginary;
        tp.cf->real = re.f;
        tp.cf++->imaginary = im.f;
      }
      break;
    case LUX_CDOUBLE:
      while (nRepeat--) {
        re.d = *lp.l * rp.cd->real;
        im.d = *lp.l++ * rp.cd++->imaginary;
        tp.cd->real = re.d;
        tp.cd++->imaginary = im.d;
      }
      break;
  ...
  case LUX_INT64:
    ...
    case LUX_CDOUBLE:
      while (nRepeat--) {
        re.d = *lp.q * rp.cd->real;
        im.d = *lp.q++ * rp.cd++->imaginary;
        tp.cd->real = re.d;
        tp.cd++->imaginary = im.d;
      }
      break;
  ...
  case LUX_INT32:
    ...
    case LUX_CFLOAT:
      while (nRepeat--) {
        d.f = rp.cf->real*rp.cf->real + rp.cf->imaginary*rp.cf->imaginary;
        d.f = 1.0/d.f;
        re.f = (*lp.l * rp.cf->real)*d.f;
        im.f = (-*lp.l++ * rp.cf++->imaginary)*d.f;
        tp.cf->real = re.f;
        tp.cf++->imaginary = im.f;
      }
      break;
    case LUX_CDOUBLE:
      while (nRepeat--) {
        d.d = rp.cd->real*rp.cd->real + rp.cd->imaginary*rp.cd->imaginary;
        d.d = 1.0/d.d;
        re.d = (*lp.l * rp.cd->real)*d.d;
        im.d = (-*lp.l++ * rp.cd++->imaginary)*d.d;
        tp.cd->real = re.d;
        tp.cd++->imaginary = im.d;
      }
      break;
  ...
  case LUX_INT64:
    ...
    case LUX_CDOUBLE:
      while (nRepeat--) {
        d.d = rp.cd->real*rp.cd->real + rp.cd->imaginary*rp.cd->imaginary;
        d.d = 1.0/d.d;
        re.d = (*lp.q * rp.cd->real)*d.d;
        im.d = (-*lp.q++ * rp.cd++->imaginary)*d.d;
        tp.cd->real = re.d;
        tp.cd++->imaginary = im.d;
      }
      break;
     ...
     // remainder-taking with array operands
{
  ...
  case LUX_INT8:
    ...
    case LUX_INT32:
      while (nRepeat--)
        *tp.l++ = iasmod(*lp.ui8++, *rp.l++);
      break;
    case LUX_INT64:
      while (nRepeat--)
        *tp.q++ = i64asmod(*lp.ui8++, *rp.q++);
      break;
    case LUX_FLOAT:
      while (nRepeat--)
  ...
  case LUX_INT16:
    ...
    case LUX_INT32:
      while (nRepeat--)
        *tp.l++ = iasmod(*lp.i16++, *rp.l++);
      break;
    case LUX_INT64:
      while (nRepeat--)
        *tp.q++ = i64asmod(*lp.i16++, *rp.q++);
      break;
    case LUX_FLOAT:
      while (nRepeat--)
  ...
  case LUX_INT32:
    ...
    case LUX_INT8:
      while (nRepeat--)
        *tp.l++ = iasmod(*lp.l++, *rp.ui8++);
      break;
    case LUX_INT16:
      while (nRepeat--)
        *tp.l++ = iasmod(*lp.l++, *rp.i16++);
      break;
    case LUX_INT32:
      while (nRepeat--)
  ...
  case LUX_INT64:
    ...
    case LUX_INT8:
      while (nRepeat--)
        *tp.q++ = iasmod(*lp.q++, *rp.ui8++);
      break;
    case LUX_INT16:
      while (nRepeat--)
        *tp.q++ = iasmod(*lp.q++, *rp.i16++);
      break;
    case LUX_INT32:
      while (nRepeat--)
     ...
     // remainder-taking with array LHS and scalar RHS
{
  ...
  case LUX_INT64:
    ...
    case LUX_INT8:
      while (nRepeat--)
        *tp.q++ = i64asmod(*lp.q++, *rp.ui8);
      break;
    case LUX_INT16:
      while (nRepeat--)
        *tp.q++ = i64asmod(*lp.q++, *rp.i16);
      break;
    case LUX_INT32:
      while (nRepeat--)
     ...
     // remainder-taking with array operands
{
  ...
  case LUX_INT8:
    ...
    case LUX_INT32:
      while (nRepeat--)
        *tp.l++ = iamod(*lp.ui8++, *rp.l++);
      break;
    case LUX_INT64:
      while (nRepeat--)
        *tp.q++ = i64amod(*lp.ui8++, *rp.q++);
      break;
    case LUX_FLOAT:
      while (nRepeat--)
  ...
  case LUX_INT16:
    ...
    case LUX_INT64:
      while (nRepeat--)
        *tp.q++ = i64amod(*lp.i16++, *rp.q++);
      break;
    case LUX_INT32:
      while (nRepeat--)
        *tp.l++ = iamod(*lp.i16++, *rp.l++);
      break;
    case LUX_FLOAT:
      while (nRepeat--)
  ...
  case LUX_INT32:
    ...
    case LUX_INT8:
      while (nRepeat--)
        *tp.l++ = iamod(*lp.l++, *rp.ui8++);
      break;
    case LUX_INT16:
      while (nRepeat--)
        *tp.l++ = iamod(*lp.l++, *rp.i16++);
      break;
    case LUX_INT32:
      while (nRepeat--)
  ...
  case LUX_INT64:
    ...
    case LUX_INT8:
      while (nRepeat--)
        *tp.q++ = i64amod(*lp.q++, *rp.ui8++);
      break;
    case LUX_INT16:
      while (nRepeat--)
        *tp.q++ = i64amod(*lp.q++, *rp.i16++);
      break;
    case LUX_INT32:
      while (nRepeat--)
...
//   5 NaN  NaN
{
  ...
  case LUX_INT8:
    ...
    case LUX_INT32:
      while (nRepeat--)
        *tp.l++ = ((value1.l = *lp.ui8++) > (value2.l = *rp.l++))?
          value1.l:
          value2.l;
          break;
    case LUX_INT64:
      while (nRepeat--)
        *tp.q++ = ((value1.q = *lp.ui8++) > (value2.q = *rp.q++))?
          value1.q:
          value2.q;
          break;
    case LUX_FLOAT:
  ...
  case LUX_INT16:
    ...
    case LUX_INT64:
      while (nRepeat--)
        *tp.q++ = ((value1.q = *lp.i16++) > (value2.q = *rp.q++))?
          value1.q:
          value2.q;
          break;
    case LUX_INT32:
      while (nRepeat--)
        *tp.l++ = ((value1.l = *lp.i16++) > (value2.l = *rp.l++))?
          value1.l:
          value2.l;
          break;
    case LUX_FLOAT:
  ...
  case LUX_INT32:
    ...
    case LUX_INT8:
      while (nRepeat--)
        *tp.l++ = ((value1.l = *lp.l++) > (value2.l = *rp.ui8++))?
          value1.l:
          value2.l;
          break;
    case LUX_INT16:
      while (nRepeat--)
        *tp.l++ = ((value1.l = *lp.l++) > (value2.l = *rp.i16++))?
          value1.l:
          value2.l;
          break;
    case LUX_INT32:
  ...
  case LUX_INT64:
    ...
    case LUX_INT8:
      while (nRepeat--)
        *tp.q++ = ((value1.q = *lp.q++) > (value2.q = *rp.ui8++))?
          value1.q:
          value2.q;
          break;
    case LUX_INT16:
      while (nRepeat--)
        *tp.q++ = ((value1.q = *lp.q++) > (value2.q = *rp.i16++))?
          value1.q:
          value2.q;
          break;
    case LUX_INT32:
     ...
     // equal-to with array operands
{
  ...
  case LUX_INT8:
    ...
    case LUX_CFLOAT:
      while (nRepeat--) {
        *tp.l++ = (*lp.ui8 == rp.cf->real && rp.cf->imaginary == 0);
        lp.ui8++;
        rp.cf++;
      }
      break;
    case LUX_CDOUBLE:
      while (nRepeat--) {
        *tp.l++ = (*lp.ui8 == rp.cd->real && rp.cd->imaginary == 0);
        lp.ui8++;
        rp.cd++;
      }
      break;
  ...
  case LUX_INT16:
    ...
    case LUX_CFLOAT:
      while (nRepeat--) {
        *tp.l++ = (*lp.i16 == rp.cf->real && rp.cf->imaginary == 0);
        lp.i16++;
        rp.cf++;
      }
      break;
    case LUX_CDOUBLE:
      while (nRepeat--) {
        *tp.l++ = (*lp.i16 == rp.cd->real && rp.cd->imaginary == 0);
        lp.i16++;
        rp.cd++;
      }
      break;
  ...
  case LUX_INT64:
    ...
    case LUX_CFLOAT:
      while (nRepeat--) {
        *tp.l++ = (*lp.q == rp.cf->real && rp.cf->imaginary == 0);
        lp.l++;
        rp.cf++;
      }
      break;
    case LUX_CDOUBLE:
      while (nRepeat--) {
        *tp.l++ = (*lp.q == rp.cd->real && rp.cd->imaginary == 0);
        lp.l++;
        rp.cd++;
      }
      break;
  ...
  case LUX_CFLOAT:
    ...
    case LUX_INT8:
      while (nRepeat--) {
        *tp.l++ = (lp.cf->real == *rp.ui8 && lp.cf->imaginary == 0);
        lp.cf++;
        rp.ui8++;
      }
      break;
    case LUX_INT16:
      while (nRepeat--) {
        *tp.l++ = (lp.cf->real == *rp.i16 && lp.cf->imaginary == 0);
        lp.cf++;
        rp.i16++;
      }
      break;
  ...
  case LUX_CDOUBLE:
    ...
    case LUX_INT8:
      while (nRepeat--) {
        *tp.l++ = (lp.cd->real == *rp.ui8 && lp.cd->imaginary == 0);
        lp.cd++;
        rp.ui8++;
      }
      break;
    case LUX_INT16:
      while (nRepeat--) {
        *tp.l++ = (lp.cd->real == *rp.i16 && lp.cd->imaginary == 0);
        lp.cd++;
        rp.i16++;
      }
      break;
     ...
     // greater-than with two array operands
{
  ...
  case LUX_INT8:
    ...
    case LUX_CFLOAT:
      /* we want +1 > -1 and also +i > -i; we get that by comparing
         ...
         (a+bi) > (c+di) if (a+b) > (c+d) */
      while (nRepeat--) {
        *tp.l++ = (*lp.ui8 > rp.cf->real + rp.cf->imaginary);
        lp.ui8++;
        rp.cf++;
      }
      break;
    case LUX_CDOUBLE:
      /* we want +1 > -1 and also +i > -i; we get that by comparing
         ...
         (a+bi) > (c+di) if (a+b) > (c+d) */
      while (nRepeat--) {
        *tp.l++ = (*lp.ui8 > rp.cd->real + rp.cd->imaginary);
        lp.ui8++;
        rp.cd++;
      }
      break;
  ...
  case LUX_INT16:
    ...
    case LUX_CFLOAT:
      /* we want +1 > -1 and also +i > -i; we get that by comparing
         ...
         (a+bi) > (c+di) if (a+b) > (c+d) */
      while (nRepeat--) {
        *tp.l++ = (*lp.i16 > rp.cf->real + rp.cf->imaginary);
        lp.i16++;
        rp.cf++;
      }
      break;
    case LUX_CDOUBLE:
      /* we want +1 > -1 and also +i > -i; we get that by comparing
         ...
         (a+bi) > (c+di) if (a+b) > (c+d) */
      while (nRepeat--) {
        *tp.l++ = (*lp.i16 > rp.cd->real + rp.cd->imaginary);
        lp.i16++;
        rp.cd++;
      }
      break;
  ...
  case LUX_CFLOAT:
    ...
    case LUX_INT8:
      while (nRepeat--) {
        *tp.l++ = (lp.cf->real + lp.cf->imaginary > *rp.ui8);
        lp.cf++;
        rp.ui8++;
      }
      break;
    case LUX_INT16:
      while (nRepeat--) {
        *tp.l++ = (lp.cf->real + lp.cf->imaginary > *rp.i16);
        lp.cf++;
        rp.i16++;
      }
      break;
  ...
  case LUX_CDOUBLE:
    ...
    case LUX_INT8:
      while (nRepeat--) {
        *tp.l++ = (lp.cd->real + lp.cd->imaginary > *rp.ui8);
        lp.cd++;
        rp.ui8++;
      }
      break;
    case LUX_INT16:
      while (nRepeat--) {
        *tp.l++ = (lp.cd->real + lp.cd->imaginary > *rp.i16);
        lp.cd++;
        rp.i16++;
      }
      break;
            ...
            case LUX_RANGE:
              ...
              switch (symbol_class(result)) {
                ...
                case LUX_ARRAY:
                  ...
                  for (i = 0; i < n; i++)
                    *q.i16++ = copySym(clist_symbols(target)[*p.l++]);
                  break;
                default:
              ...
              switch (symbol_class(result)) {
                ...
                case LUX_ARRAY:
                  ...
                  if (!q.i16)
                    return cerror(ALLOC_ERR, symbol);
                  for (i = 0; i < n; i++)
                    *q.i16++ = copySym(list_symbol(target, *p.l++));
                  break;
                default:
                  return luxerror("Not implemented", symbol);
              }
