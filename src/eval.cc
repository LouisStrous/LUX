...
//   5 NaN  NaN
{
  ...
  case LUX_INT32:
    ...
    case LUX_INT64:
      while (nRepeat--)
        *tp.q++ = ((value1.q = *lp.i32++) > (value2.q = *rp.q++))?
          value1.q:
          value2.q;
          break;
    case LUX_FLOAT:
  ...
  case LUX_INT64:
    ...
    case LUX_INT32:
      while (nRepeat--)
        *tp.q++ = ((value1.q = *lp.q++) > (value2.q = *rp.i32++))?
          value1.q:
          value2.q;
          break;
    case LUX_INT64:
     ...
     // equal-to with array operands
{
  ...
  case LUX_INT64:
    ...
    case LUX_CFLOAT:
      while (nRepeat--) {
        *tp.i32++ = (*lp.q == rp.cf->real && rp.cf->imaginary == 0);
        lp.i32++;
        rp.cf++;
      }
      break;
    case LUX_CDOUBLE:
      while (nRepeat--) {
        *tp.i32++ = (*lp.q == rp.cd->real && rp.cd->imaginary == 0);
        lp.i32++;
        rp.cd++;
      }
      break;
  ...
  case LUX_CFLOAT:
    ...
    case LUX_INT64:
      while (nRepeat--) {
        *tp.i32++ = (lp.cf->real == *rp.q && lp.cf->imaginary == 0);
        lp.cf++;
        rp.q++;
      }
      break;
  ...
  case LUX_CDOUBLE:
    ...
    case LUX_INT64:
      while (nRepeat--) {
        *tp.i32++ = (lp.cd->real == *rp.q && lp.cd->imaginary == 0);
        lp.cd++;
        rp.q++;
      }
      break;
     ...
     // greater-than with two array operands
{
  ...
  case LUX_INT64:
    ...
    case LUX_CFLOAT:
      /* we want +1 > -1 and also +i > -i; we get that by comparing
         ...
         (a+bi) > (c+di) if (a+b) > (c+d) */
      while (nRepeat--) {
        *tp.i32++ = (*lp.q > rp.cf->real + rp.cf->imaginary);
        lp.q++;
        rp.cf++;
      }
      break;
    case LUX_CDOUBLE:
      /* we want +1 > -1 and also +i > -i; we get that by comparing
         ...
         (a+bi) > (c+di) if (a+b) > (c+d) */
      while (nRepeat--) {
        *tp.i32++ = (*lp.q > rp.cd->real + rp.cd->imaginary);
        lp.q++;
        rp.cd++;
      }
      break;
  ...
  case LUX_CFLOAT:
    ...
    case LUX_INT64:
      while (nRepeat--) {
        *tp.i32++ = (lp.cf->real + lp.cf->imaginary > *rp.q);
        lp.cf++;
        rp.q++;
      }
      break;
  ...
  case LUX_CDOUBLE:
    ...
    case LUX_INT64:
      while (nRepeat--) {
        *tp.i32++ = (lp.cd->real + lp.cd->imaginary > *rp.q);
        lp.cd++;
        rp.q++;
      }
      break;
