  ...
  switch (symbol_class(source)) {
    case LUX_SCAL_PTR:
      if (scal_ptr_type(source) == LUX_TEMP_STRING) {
        ...
        memcpy(&scalar_value(target), scal_ptr_pointer(source).ui8,
               sizeof(Scalar));
        ...
        switch (scal_ptr_type(lhs)) {
          ...
          case LUX_INT16:
            *scal_ptr_pointer(lhs).i16 = scalar_value(rhs).i16;
            break;
          case LUX_INT32:
            *scal_ptr_pointer(lhs).i32 = scalar_value(rhs).i32;
            break;
          case LUX_INT64:
            *scal_ptr_pointer(lhs).i64 = scalar_value(rhs).i64;
            break;
          case LUX_FLOAT:
...
// executes LUX FOR-statement
{
 ...
 counter.ui8 = &scalar_value(counterSym).ui8;
 ...
 switch (hiType) {
   ...
   case LUX_INT16:
     ...
     break;
   case LUX_INT32:
     forward = (inc.i32 >= 0)? 1: 0;
     break;
   case LUX_INT64:
     forward = (inc.i64 >= 0)? 1: 0;
     break;
   case LUX_FLOAT:
     forward = (inc.f >= 0)? 1: 0;
     break;
 ...
 switch (hiType) {
   ...
   case LUX_INT16:
     *counter.i16 = start.i16;
     break;
   case LUX_INT32:
     *counter.i32 = start.i32;
     break;
   case LUX_INT64:
     *counter.i64 = start.i64;
     break;
   case LUX_FLOAT:
     *counter.f = start.f;
     compensation.f = 0;
 ...
 if (forward)
   ...
   case LUX_INT16:
     ...
     break;
   case LUX_INT32:
     n = *counter.i32 > end.i32? 0: 1;
     break;
   case LUX_INT64:
     n = *counter.i64 > end.i64? 0: 1;
     break;
   case LUX_FLOAT:
 ...
 switch (hiType) {
   case LUX_INT8:
     if (action)
       while (n) {
         ...
         printf("%1d,%1d,%1d; counter %s = %1d\n", start.ui8, end.ui8, inc.ui8,
                symbolIdent(counterSym, 0), *counter.ui8);
         n = execute(temp);
         switch (n) {
           case LOOP_BREAK:
             n = 0;
         ...
         *counter.ui8 += inc.ui8;
         n = forward? (*counter.ui8 > end.ui8? 0: 1): (*counter.ui8 < end.ui8? 0: 1);
       }
     else
       while (n) {
         n = execute(temp);
   ...
   case LUX_INT32:
     if (action)
       while (n) {
         printf("FOR-loop: ");  // show for-loop status
         printf("%1d,%1d,%1d; counter %s = %1d\n", start.i32, end.i32, inc.i32,
                symbolIdent(counterSym, 0), *counter.i32);
         n = execute(temp);
         switch (n) {
           case LOOP_BREAK:
             n = 0;
         ...
         *counter.i32 += inc.i32;
         n = forward? (*counter.i32 > end.i32? 0: 1): (*counter.i32 < end.i32? 0: 1);
       }
     else
       while (n) {
         n = execute(temp);
   ...
   case LUX_INT64:
     if (action)
       while (n) {
         printf("FOR-loop: ");  // show for-loop status
         printf("%1d,%1d,%1d; counter %s = %1d\n", start.i64, end.i64, inc.i64,
                symbolIdent(counterSym, 0), *counter.i64);
         n = execute(temp);
         switch (n) {
           case LOOP_BREAK:
             n = 0;
         ...
         *counter.i64 += inc.i64;
         n = forward? (*counter.i64 > end.i64? 0: 1): (*counter.i64 < end.i64? 0: 1);
       }
     else
       while (n) {
         n = execute(temp);
  ...
  switch (evb_type(symbol)) {
    ...
    case EVB_IF:
      ...
      case LUX_INT16:
        ...
        break;
      case LUX_INT32:
        n = scalar_value(temp).i32? 1: 0;
        break;
      case LUX_INT64:
        n = scalar_value(temp).i64? 1: 0;
        break;
      case LUX_FLOAT:
   ...
   ps[narg - 1]: target */
{
  ...
  switch (class_id) {
    ...
    case LUX_ARRAY: case LUX_CARRAY:
      ...
      trgt.i32 = (int32_t *) array_data(target);
      break;
  }
  ...
  switch (symbol_class(source)) {
    ...
    case LUX_SCALAR:
      ...
      src.i32 = &scalar_value(source).i32;
      break;
    case LUX_CSCALAR:
      srcNdim = 1;
      srcNelem = 1;
        ...
        for (j = 0; j < size[0]; j++) {
          ...
          switch (type) {
            case LUX_INT8: case LUX_TEMP_STRING:
              switch (srcType) {
                ...
                case LUX_INT16:
                  ...
                  break;
                case LUX_INT32:
                  trgt.ui8[offset] = (uint8_t) *src.i32;
                  break;
                case LUX_INT64:
                  trgt.ui8[offset] = *src.i64;
                  break;
                case LUX_FLOAT:
                  trgt.ui8[offset] = (uint8_t) *src.f;
                  break;
                case LUX_DOUBLE:
                  trgt.ui8[offset] = (uint8_t) *src.d;
                  break;
                case LUX_CFLOAT:
                  trgt.ui8[offset] = hypot(src.cf->real, src.cf->imaginary);
                  break;
                case LUX_CDOUBLE:
                  trgt.ui8[offset] = hypot(src.cd->real, src.cd->imaginary);
                  break;
              }
              break;
            case LUX_INT16:
              switch (srcType) {
                ...
                case LUX_INT16:
                  ...
                  break;
                case LUX_INT32:
                  trgt.i16[offset] = (int16_t) *src.i32;
                  break;
                case LUX_INT64:
                  trgt.i16[offset] = *src.i64;
                  break;
                case LUX_FLOAT:
            ...
            case LUX_INT32:
              switch (srcType) {
                case LUX_INT8:
                  trgt.i32[offset] = (int32_t) *src.ui8;
                  break;
                case LUX_INT16:
                  trgt.i32[offset] = (int32_t) *src.i16;
                  break;
                case LUX_INT32:
                  trgt.i32[offset] = *src.i32;
                  break;
                case LUX_INT64:
                  trgt.i32[offset] = *src.i64;
                  break;
                case LUX_FLOAT:
                  trgt.i32[offset] = (int32_t) *src.f;
                  break;
                case LUX_DOUBLE:
                  trgt.i32[offset] = (int32_t) *src.d;
                  break;
                case LUX_CFLOAT:
                  trgt.i32[offset] = hypot(src.cf->real, src.cf->imaginary);
                  break;
                case LUX_CDOUBLE:
                  trgt.i32[offset] = hypot(src.cd->real, src.cd->imaginary);
                  break;
              }
              break;
            case LUX_INT64:
              switch (srcType) {
                case LUX_INT8:
                  trgt.i64[offset] = *src.ui8;
                  break;
                case LUX_INT16:
                  trgt.i64[offset] = *src.i16;
                  break;
                case LUX_INT32:
                  trgt.i64[offset] = *src.i32;
                  break;
                case LUX_INT64:
                  trgt.i64[offset] = *src.i64;
                  break;
                case LUX_FLOAT:
                  trgt.i64[offset] = *src.f;
                  break;
                case LUX_DOUBLE:
                  trgt.i64[offset] = *src.d;
                  break;
                case LUX_CFLOAT:
                  trgt.i64[offset] = hypot(src.cf->real, src.cf->imaginary);
                  break;
                case LUX_CDOUBLE:
                  trgt.i64[offset] = hypot(src.cd->real, src.cd->imaginary);
                  break;
              }
              break;
            case LUX_FLOAT:
              switch (srcType) {
                ...
                case LUX_INT16:
                  ...
                  break;
                case LUX_INT32:
                  trgt.f[offset] = (float) *src.i32;
                  break;
                case LUX_INT64:
                  trgt.f[offset] = *src.i64;
                  break;
                case LUX_FLOAT:
                  trgt.f[offset] = *src.f;
                  break;
            ...
            case LUX_DOUBLE:
              switch (srcType) {
                ...
                case LUX_INT16:
                  ...
                  break;
                case LUX_INT32:
                  trgt.d[offset] = (double) *src.i32;
                  break;
                case LUX_INT64:
                  trgt.d[offset] = *src.i64;
                  break;
                case LUX_FLOAT:
            ...
            case LUX_CFLOAT:
              switch (srcType) {
                case LUX_INT8:
                  trgt.cf[offset].real = (float) *src.ui8;
                ...
                case LUX_INT16:
                  ...
                  break;
                case LUX_INT32:
                  trgt.cf[offset].real = (float) *src.i32;
                  trgt.cf[offset].imaginary = 0;
                  break;
                case LUX_INT64:
                  trgt.cf[offset].real = *src.i64;
                  trgt.cf[offset].imaginary = 0;
                  break;
                case LUX_FLOAT:
            ...
            case LUX_CDOUBLE:
              switch (srcType) {
                case LUX_INT8:
                  trgt.cd[offset].real = (double) *src.ui8;
                ...
                case LUX_INT16:
                  ...
                  break;
                case LUX_INT32:
                  trgt.cd[offset].real = (double) *src.i32;
                  trgt.cd[offset].imaginary = 0;
                  break;
                case LUX_INT64:
                  trgt.cd[offset].real = *src.i64;
                  trgt.cd[offset].imaginary = 0;
                  break;
                case LUX_FLOAT:
        ...
        for (j = 0; j < size[0]; j++) {
          ...
          switch (type) {
            case LUX_INT8: case LUX_TEMP_STRING:
              switch (srcType) {
                ...
                case LUX_INT16:
                  ...
                  break;
                case LUX_INT32:
                  value.ui8 = (uint8_t) *src.i32;
                  break;
                case LUX_FLOAT:
                  value.ui8 = (uint8_t) *src.f;
                  break;
                case LUX_DOUBLE:
                  value.ui8 = (uint8_t) *src.d;
                  break;
                case LUX_CFLOAT:
                  value.ui8 = sqrt(src.cf->real*src.cf->real
                                 + src.cf->imaginary*src.cf->imaginary);
                  break;
                case LUX_CDOUBLE:
                  value.ui8 = sqrt(src.cd->real*src.cd->real
            ...
            case LUX_INT32:
              switch (srcType) {
                case LUX_INT8:
                  value.i32 = (int32_t) *src.ui8;
                  break;
                case LUX_INT16:
                  value.i32 = (int32_t) *src.i16;
                  break;
                case LUX_INT32:
                  value.i32 = *src.i32;
                  break;
                case LUX_FLOAT:
                  value.i32 = (int32_t) *src.f;
                  break;
                case LUX_DOUBLE:
                  value.i32 = (int32_t) *src.d;
                  break;
                case LUX_CFLOAT:
                  value.i32 = sqrt(src.cf->real*src.cf->real
                                 + src.cf->imaginary*src.cf->imaginary);
                  break;
                case LUX_CDOUBLE:
                  value.i32 = sqrt(src.cd->real*src.cd->real
                                 + src.cd->imaginary*src.cd->imaginary);
                  break;
              }
              break;
  ...
  // combined with each value of each other coordinate
    ...
    if (!j && ndim == 1 && srcNdim == 1 && type == srcType &&
      ...
      switch (class_id) {
        case LUX_ARRAY: case LUX_CARRAY:
          memcpy(trgt.ui8 + offset0, src.ui8, srcNelem*unit);
          break;
        case LUX_FILEMAP:
          ...
          fwrite(src.ui8, unit, srcNelem, fp);
          if (ferror(fp)) {
            fclose(fp);
            return cerror(WRITE_ERR, target);
          }
            ...
            case LUX_INT8: case LUX_TEMP_STRING:
              switch (srcType) {
                ...
                case LUX_DOUBLE:
                  ...
                  break;
                case LUX_CFLOAT:
                  trgt.ui8[offset] = sqrt(src.cf->real*src.cf->real
                                        + src.cf->imaginary*src.cf->imaginary);
                  break;
                case LUX_CDOUBLE:
                  trgt.ui8[offset] = sqrt(src.cd->real*src.cd->real
                                        + src.cd->imaginary*src.cd->imaginary);
                  break;
              }
              break;
            ...
            case LUX_INT32:
              switch (srcType) {
                ...
                case LUX_DOUBLE:
                  ...
                  break;
                case LUX_CFLOAT:
                  trgt.i32[offset] = sqrt(src.cf->real*src.cf->real
                                        + src.cf->imaginary*src.cf->imaginary);
                  break;
                case LUX_CDOUBLE:
                  trgt.i32[offset] = sqrt(src.cd->real*src.cd->real
                                        + src.cd->imaginary*src.cd->imaginary);
                  break;
              }
              break;
        ...
        do {
          ...
          switch (type) {
            case LUX_INT8: case LUX_TEMP_STRING:
              switch (srcType) {
                ...
                case LUX_INT32:
                  ...
                  break;
                case LUX_INT64:
                  trgt.ui8[offset] = (uint8_t) *src.i64;
                  break;
                case LUX_FLOAT:
                  trgt.ui8[offset] = (uint8_t) *src.f;
                  break;
            ...
            case LUX_INT16:
              switch (srcType) {
                ...
                case LUX_INT32:
                  ...
                  break;
                case LUX_INT64:
                  trgt.i16[offset] = (int16_t) *src.i64;
                  break;
                case LUX_FLOAT:
                  trgt.i16[offset] = (int16_t) *src.f;
                  break;
            ...
            case LUX_INT32:
              switch (srcType) {
                ...
                case LUX_INT32:
                  ...
                  break;
                case LUX_INT64:
                  trgt.i32[offset] = (int32_t) *src.i64;
                  break;
                case LUX_FLOAT:
                  trgt.i32[offset] = (int32_t) *src.f;
                  break;
            ...
            case LUX_INT64:
              switch (srcType) {
                case LUX_INT8:
                  trgt.i64[offset] = (int64_t) *src.ui8;
                  break;
                case LUX_INT16:
                  trgt.i64[offset] = (int64_t) *src.i16;
                  break;
                case LUX_INT32:
                  trgt.i64[offset] = (int64_t) *src.i32;
                  break;
                case LUX_INT64:
                  trgt.i64[offset] = *src.i64;
                  break;
                case LUX_FLOAT:
                  trgt.i64[offset] = (int64_t) *src.f;
                  break;
                case LUX_DOUBLE:
                  trgt.i64[offset] = (int64_t) *src.d;
                  break;
                case LUX_CFLOAT:
                  trgt.i64[offset] = sqrt(src.cf->real*src.cf->real
                                        + src.cf->imaginary*src.cf->imaginary);
                  break;
                case LUX_CDOUBLE:
                  trgt.i64[offset] = sqrt(src.cd->real*src.cd->real
                                        + src.cd->imaginary*src.cd->imaginary);
                  break;
              }
              break;
        ...
        do {
          ...
          switch (type) {
            ...
            case LUX_INT64:
              switch (srcType) {
                case LUX_INT8:
                  value.i64 = (int64_t) *src.ui8;
                  break;
                case LUX_INT16:
                  value.i64 = (int64_t) *src.i16;
                  break;
                case LUX_INT32:
                  value.i64 = (int64_t) *src.i32;
                  break;
                case LUX_INT64:
                  value.i64 = *src.i64;
                  break;
                case LUX_FLOAT:
                  value.i64 = (int64_t) *src.f;
                  break;
                case LUX_DOUBLE:
                  value.i64 = (int64_t) *src.d;
                  break;
                case LUX_CFLOAT:
                  value.i64 = sqrt(src.cf->real*src.cf->real
                                 + src.cf->imaginary*src.cf->imaginary);
                  break;
                case LUX_CDOUBLE:
                  value.i64 = sqrt(src.cd->real*src.cd->real
                                 + src.cd->imaginary*src.cd->imaginary);
                  break;
              }
              break;
