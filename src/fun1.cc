            ...
            case LUX_INT8:
              do {
                ...
                do {
                  ...
                  if (psign == -1) // negative exponent: must divide
                    value.l = value.l? *weights.ui8/value.l: 0.0;
                  else
                    value.l *= *weights.ui8;
                  sum.l += value.l;
                  w.l += *weights.ui8;
            ...
            case LUX_INT16:
              do {
                ...
                do {
                  ...
                  // add in the exponent sign and the weight
                  if (psign == -1) // negative exponent: must divide
                    value.l = value.l? *weights.i16/value.l: 0.0;
                  else
                    value.l *= *weights.i16;
                  sum.l += value.l;
                  w.l += *weights.i16;
            ...
            case LUX_INT8:
              do {
                ...
                do {
                  ...
                  // add in the exponent sign and the weight
                  if (psign == -1) // negative exponent: must divide
                    value.q = value.q? *weights.ui8/value.q: 0.0;
                  else
                    value.q *= *weights.ui8;
                  sum.q += value.q;
                  w.q += *weights.ui8;
            ...
            case LUX_INT16:
              do {
                ...
                do {
                  ...
                  // add in the exponent sign and the weight
                  if (psign == -1) // negative exponent: must divide
                    value.q = value.q? *weights.i16/value.q: 0.0;
                  else
                    value.q *= *weights.i16;
                  sum.q += value.q;
                  w.q += *weights.i16;
    ...
    switch (type1) {
      case LUX_INT8:
        switch (type2) {
          ...
          case LUX_INT32:
            while (nelem--)
              *trgt.f++ = (*func_dd[code])(*src1.ui8++, *src2.l++);
            break;
          case LUX_INT64:
            while (nelem--)
              *trgt.f++ = (*func_dd[code])(*src1.ui8++, *src2.q++);
            break;
          case LUX_FLOAT:
            while (nelem--)
      ...
      case LUX_INT16:
        switch (type2) {
          ...
          case LUX_INT32:
            while (nelem--)
              *trgt.f++ = (*func_dd[code])(*src1.i16++, *src2.l++);
            break;
          case LUX_INT64:
            while (nelem--)
              *trgt.f++ = (*func_dd[code])(*src1.i16++, *src2.q++);
            break;
          case LUX_FLOAT:
            while (nelem--)
      ...
      case LUX_INT32:
        switch (type2) {
          case LUX_INT8:
            while (nelem--)
              *trgt.f++ = (*func_dd[code])(*src1.l++, *src2.ui8++);
            break;
          case LUX_INT16:
            while (nelem--)
              *trgt.f++ = (*func_dd[code])(*src1.l++, *src2.i16++);
            break;
          case LUX_INT32:
            while (nelem--)
      ...
      case LUX_INT64:
        switch (type2) {
          case LUX_INT8:
            while (nelem--)
              *trgt.f++ = (*func_dd[code])(*src1.q++, *src2.ui8++);
            break;
          case LUX_INT16:
            while (nelem--)
              *trgt.f++ = (*func_dd[code])(*src1.q++, *src2.i16++);
            break;
          case LUX_INT32:
            while (nelem--)
    ...
    switch (type1) {
      case LUX_INT8:
        switch (type2) {
          ...
          case LUX_INT32:
            while (nelem--)
              *trgt.f++ = (*func_id[code])(*src1.ui8++, *src2.l++);
            break;
          case LUX_INT64:
            while (nelem--)
              *trgt.f++ = (*func_id[code])(*src1.ui8++, *src2.q++);
            break;
          case LUX_FLOAT:
            while (nelem--)
      ...
      case LUX_INT16:
        switch (type2) {
          ...
          case LUX_INT32:
            while (nelem--)
              *trgt.f++ = (*func_id[code])(*src1.i16++, *src2.l++);
            break;
          case LUX_INT64:
            while (nelem--)
              *trgt.f++ = (*func_id[code])(*src1.i16++, *src2.q++);
            break;
          case LUX_FLOAT:
            while (nelem--)
      ...
      case LUX_INT32:
        switch (type2) {
          case LUX_INT8:
            while (nelem--)
              *trgt.f++ = (*func_id[code])(*src1.l++, *src2.ui8++);
            break;
          case LUX_INT16:
            while (nelem--)
              *trgt.f++ = (*func_id[code])(*src1.l++, *src2.i16++);
            break;
          case LUX_INT32:
            while (nelem--)
      ...
      case LUX_INT64:
        switch (type2) {
          case LUX_INT8:
            while (nelem--)
              *trgt.f++ = (*func_id[code])(*src1.q++, *src2.ui8++);
            break;
          case LUX_INT16:
            while (nelem--)
              *trgt.f++ = (*func_id[code])(*src1.q++, *src2.i16++);
            break;
          case LUX_INT32:
            while (nelem--)
