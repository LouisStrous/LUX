  ...
  switch (type) {
    case LUX_INT8:
      ...
      switch (colorIndexType) {
        ...
        case LUX_INT16:
          while (n--)
            *q2.w++ = (xq*(*q1.ui8++ - min.ui8))/range.l + scalemin;
          break;
        case LUX_INT32:
          while (n--)
    ...
    case LUX_INT16:
      ...
      switch (colorIndexType) {
        case LUX_INT8:
          while (n--)
            *q2.ui8++ = (xq*(*q1.w++ - min.w))/range.l + scalemin;
          break;
        case LUX_INT16:
          while (n--)
