...
float averag(void *m, int32_t nxa, int32_t nxb, int32_t nya, int32_t nyb, int32_t nxs, int32_t nys,
  ...
  resid(int32_t *m1, int32_t *m2, int32_t idx, int32_t idy, int32_t nxa, int32_t nxb, int32_t nya,
        ...
        float bs);
//-------------------------------------------------------------------------
int32_t lux_gridmatch(ArgumentCount narg, int32_t ps[])/* gridmatch function */               
...
//-------------------------------------------------------------------------
int32_t lux_stretch(ArgumentCount narg, int32_t ps[])// stretch function
...
//-------------------------------------------------------------------------
void getmin(float *, float *, float *);
int32_t lux_getmin9(ArgumentCount narg, int32_t ps[])/* getmin9 function */           
...
int32_t lux_getmin2(ArgumentCount narg, int32_t ps[])/* getmin2 function */           
// local minimum for a 3x3 array
{
  int32_t       iq;
  float         *p, x0, y0;
...
//-------------------------------------------------------------------------
int32_t lux_expand(ArgumentCount narg, int32_t ps[])
{
  float         sx, sy;
  int32_t       smt;
...
void bicubic_fc()       // internal routine for single pixel
{
 ...
 //-------------------------------------------------------------------------
int32_t lux_regrid(ArgumentCount narg, int32_t ps[]) // regrid function
 ...
 //-------------------------------------------------------------------------
int32_t lux_regrid3(ArgumentCount narg, int32_t ps[]) // regrid3 function
 ...
 //-------------------------------------------------------------------------
int32_t lux_regrid3ns(ArgumentCount narg, int32_t ps[]) // regrid3ns function
 // call is Y = REGRID3( X, XG, YG, DX, DY)
 /* similar to regrid but uses bicubic interpolation rather than nearest
 ...
 //-------------------------------------------------------------------------
int32_t regrid_common(ArgumentCount narg, int32_t ps[])// with branches for type
{
...
//-------------------------------------------------------------------------
int32_t lux_compress(ArgumentCount narg, int32_t ps[])
...
//-------------------------------------------------------------------------
int32_t lux_oldcompress(ArgumentCount narg, int32_t ps[]) // compress function
...
//  xc = compress(x, cx, [cy])
{
 ...
 //-------------------------------------------------------------------------
int32_t lux_sort(ArgumentCount narg, int32_t ps[])
//sort contents of a copy of an array
{
 ...
 //-------------------------------------------------------------------------
int32_t lux_index(ArgumentCount narg, int32_t ps[])
 ...
 // internal routine for shift in one direction
{
 ...
 //-------------------------------------------------------------------------
int32_t lux_shift3(ArgumentCount narg, int32_t ps[])  // shift3, bicubic image shift
 // y = shift3(x, dx, dy)
...
//-------------------------------------------------------------------------
int32_t lux_regridls(ArgumentCount narg, int32_t ps[])
...
//-------------------------------------------------------------------------
int32_t lux_bigger235(ArgumentCount narg, int32_t ps[])
{
...
#endif
//-------------------------------------------------------------------------
int32_t lux_cartesian_to_polar(ArgumentCount narg, int32_t ps[])
// y = CTOP(x [, x0, y0])
{
#if HAVE_LIBGSL
...
//-------------------------------------------------------------------------
int32_t lux_polar_to_cartesian(ArgumentCount narg, int32_t ps[])
