...
/* LS 10mar99: adapted to use config.h */
#if STDC_HEADERS
#define HAVE_STDC
#endif
...
/* LS 10mar99: use config.h results */
#if SIZEOF_UNSIGNED_CHAR != 0
#define HAVE_UNSIGNED_CHAR
#endif
#if SIZEOF_UNSIGNED_SHORT_INT != 0
#define HAVE_UNSIGNED_WORD
#endif

/* LS 10mar99: commented out in favor of above checks
...
/* #define void char */
/* LS 10mar99: taken care of by configure. */
