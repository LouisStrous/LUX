...
METHODDEF void c_ui_method_selection (compress_info_ptr cinfo)
{
 ...
 //-------------------------------------------------------------------------
int32_t lux_write_jpeg_f(ArgumentCount narg, Symbol ps[])
// a function version that returns 1 if read OK
{
 ...
 //-------------------------------------------------------------------------
int32_t lux_write_jpeg(ArgumentCount narg, Symbol ps[])        // jpeg write subroutine
...
METHODDEF void d_ui_method_selection (decompress_info_ptr cinfo)
 ...
 //-------------------------------------------------------------------------
int32_t lux_read_jpeg_f(ArgumentCount narg, Symbol ps[])
// a function version that returns 1 if read OK
{
 ...
 //-------------------------------------------------------------------------
int32_t lux_read_jpeg(ArgumentCount narg, Symbol ps[])        // jpeg read subroutine
 // 10/17/92, start with 2-D uint8_t files
 {
 char        *name;
