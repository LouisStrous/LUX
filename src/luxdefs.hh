...
typedef struct {
  /** A pointer to a \c pointer to the current data element.  For
      example, if the data type is \c LUX_DOUBLE, then the current
