...
BIND(iauBi00, v_dpT3_rD3_000, f, bi00, 0, 0, 0)
/*-----------------------------------------------------------------------*/
/* bp00, jd, rb, rp, rbp
...
BIND(iauBp00, v_dddp3T3_iLaoD33oDp3p3qDcq_0z1T3, s, bp00, 4, 4, 0)
/*-----------------------------------------------------------------------*/
/* bp06, jd, rb, rp, rbp
 ...
 */
BIND(iauC2ixy, v_dT4dp3_iDaT3rDp3p3q_0z1T3, f, c2ixy, 3, 3, 0)
/*-----------------------------------------------------------------------*/
/* rc2i = c2ixys(x, y, s)
 ...
 */
BIND(iauC2ixys, v_dT3dp3_iDaT3rDp3p3q_0T3, f, c2ixys, 3, 3, 0)
/*-----------------------------------------------------------------------*/
/* angles = c2s(p)
   ...
   */
BIND(iauC2s, v_dpT3_iD3arDm3p2q_011, f, c2s, 1, 1, 0)
/*-----------------------------------------------------------------------*/
...
BIND(iauC2t00a, v_dT6dp3_iDaT4rDp3p3q_0z11T4, f, c2t00a, 4, 4, 0)
/*-----------------------------------------------------------------------*/
/* rc2t = c2t00b(jdtt, jdut, x, y)
   ...
   model.  <jdtt> and <jdut> should express the same instants in time,
   in the TT and UT1 timescales, respectively */
BIND(iauC2t00b, v_dT6dp3_iDaT4rDp3p3q_0z11T4, f, c2t00b, 4, 4, 0)
/*-----------------------------------------------------------------------*/
/* rc2t = c2t06a(jd, x, y)
   ...
   respectively */
BIND(iauC2t06a, v_dT6dp3_iDaT4rDp3p3q_0z11T4, f, c2t06a, 4, 4, 0)
/*-----------------------------------------------------------------------*/
...
BIND(iauC2tcio, v_dp3ddp3dp3_iD33aDmmaDarDq_0T3, f, c2tcio, 3, 3, 0)
/*-----------------------------------------------------------------------*/
...
BIND(iauC2teqx, v_dp3ddp3dp3_iD33aDmmaDarDq_0T3, f, c2teqx, 3, 3, 0)
/*-----------------------------------------------------------------------*/
/* c2tpe(jd, dpsi, deps, xp, yp)
   ...
   <yp> */
BIND(iauC2tpe, v_dT8dp3_iDaT5rDp3p3q_0zzz1T5, f, c2tpe, 5, 5, 0)
/*-----------------------------------------------------------------------*/
/* c2txy(jd, x, y, xp, yp)
   ...
   <yp> */
BIND(iauC2txy, v_dT8dp3_iDaT5rDp3p3q_0zzz1T5, f, c2txy, 5, 5, 0)
/*-----------------------------------------------------------------------*/
/* cal2jd(<caldates>)
...
BIND(iauEpj, d_dd_iLarDq_0z_1, f, epj, 1, 1, 0)
/*-----------------------------------------------------------------------*/
/* epj2jd(<bepoch>)
...
BIND(iauEpv00, i_dddp3dp3_iLaoDp2p3qT2_0z12, s, epv00, 3, 3, 0)
/*-----------------------------------------------------------------------*/
/* eqeq94(<jd>)

   Returns the equation of the equinoxes according to the IAU 1994 model.
 */
BIND(iauEqeq94, d_dd_iLarDq_0z_1, f, eqeq94, 1, 1, 0)
/*-----------------------------------------------------------------------*/
/* era00(<jd>)

   Returns the Earth rotation angle according to the IAU 2000 model.
*/
BIND(iauEra00, d_dd_iLarDq_0z_1, f, era00, 1, 1, 0)
/*-----------------------------------------------------------------------*/
/* fad03(<t>)
   ...
   instead. */
BIND(iauFad03, d_d_iDarDq_0_1, f, fad03, 1, 1, 0)
/*-----------------------------------------------------------------------*/
/* fae03(<t>)
   ...
   instead. */
BIND(iauFae03, d_d_iDarDq_0_1, f, fae03, 1, 1, 0)
/*-----------------------------------------------------------------------*/
/* faf03(<t>)
...
BIND(iauFaf03, d_d_iDarDq_0_1, f, faf03, 1, 1, 0)
/*-----------------------------------------------------------------------*/
/* faju03(<t>)
   ...
   practical difference if <t> is measured since J2000.0 TT
   instead. */
BIND(iauFaju03, d_d_iDarDq_0_1, f, faju03, 1, 1, 0)
/*-----------------------------------------------------------------------*/
/* fal03(<t>)
   ...
   practical difference if <t> is measured since J2000.0 TT
   instead. */
BIND(iauFal03, d_d_iDarDq_0_1, f, fal03, 1, 1, 0)
/*-----------------------------------------------------------------------*/
/* falp03(<t>)
   ...
   practical difference if <t> is measured since J2000.0 TT
   instead. */
BIND(iauFalp03, d_d_iDarDq_0_1, f, falp03, 1, 1, 0)
/*-----------------------------------------------------------------------*/
/* fama03(<t>)
   ...
   practical difference if <t> is measured since J2000.0 TT
   instead. */
BIND(iauFama03, d_d_iDarDq_0_1, f, fama03, 1, 1, 0)
/*-----------------------------------------------------------------------*/
/* fame03(<t>)
   ...
   practical difference if <t> is measured since J2000.0 TT
   instead. */
BIND(iauFame03, d_d_iDarDq_0_1, f, fame03, 1, 1, 0)
/*-----------------------------------------------------------------------*/
/* fane03(<t>)
   ...
   practical difference if <t> is measured since J2000.0 TT
   instead. */
BIND(iauFane03, d_d_iDarDq_0_1, f, fane03, 1, 1, 0)
/*-----------------------------------------------------------------------*/
/* faom03(<t>)
   ...
   TT instead. */
BIND(iauFaom03, d_d_iDarDq_0_1, f, faom03, 1, 1, 0)
/*-----------------------------------------------------------------------*/
/* fapa03(<t>)
   ...
   It makes no practical difference if <t> is measured since J2000.0
   TT instead. */
BIND(iauFapa03, d_d_iDarDq_0_1, f, fapa03, 1, 1, 0)
/*-----------------------------------------------------------------------*/
/* fasa03(<t>)
   ...
   practical difference if <t> is measured since J2000.0 TT
   instead. */
BIND(iauFasa03, d_d_iDarDq_0_1, f, fasa03, 1, 1, 0)
/*-----------------------------------------------------------------------*/
/* faur03(<t>)
   ...
   practical difference if <t> is measured since J2000.0 TT
   instead. */
BIND(iauFaur03, d_d_iDarDq_0_1, f, faur03, 1, 1, 0)
/*-----------------------------------------------------------------------*/
/* fave03(<t>)
   ...
   practical difference if <t> is measured since J2000.0 TT
   instead. */
BIND(iauFave03, d_d_iDarDq_0_1, f, fave03, 1, 1, 0)
/*-----------------------------------------------------------------------*/
...
BIND(iauFk52h, v_dT6dpT6_iDaT6oDqT6_0T11, s, fk52h, 12, 12, 0)
/*-----------------------------------------------------------------------*/
/* fk5hip, <r5h>, <s5h>

   Returns the FK5-to-Hipparcos rotation <r5h> and spin <s5h> */
BIND(iauFk5hip, v_dp3dp_oD33D3_01, s, fk5hip, 2, 2, 0)
/*-----------------------------------------------------------------------*/
...
/* fw2xy, <gamma_bar>, <phi_bar>, <psi>, <eps>, <x>, <y>
   ...
   <eps>. */
BIND(iauFw2xy, v_dT4dpdp_iDaT4oDqDq_0T5, s, fw2xy, 6, 6, 0)
/*-----------------------------------------------------------------------*/
/* gc2gd(<xyz>, <ellid>)
...
BIND(iauGc2gd, i_idpT4_iL1D3arDcq_0T222, f, gc2gd, 2, 2, 0)
/*-----------------------------------------------------------------------*/
/* gc2gde(<xyz>, <a>, <f>)
...
BIND(iauGc2gde, v_dT3d3_iD3aD1D1rD3q_120333, f, gc2gde, 3, 3, 0)
/*-----------------------------------------------------------------------*/
/* gd2gc(<eph>, <ellid>)
   ...
   reference ellipsoid <ellid> */
BIND(iauGd2gc, i_idT3dp_iD3aL1rDq_10002, f, gd2gc, 2, 2, 0)
/*-----------------------------------------------------------------------*/
/* gd2gce(<eph>, <a>, <f>)
   ...
   ellipsoid with equatorial radius <a> and flattening <f> */
BIND(iauGd2gce, i_dT5dp_iD3aD1D1rD3q_120003, f, gd2gce, 3, 3, 0)
/*-----------------------------------------------------------------------*/
/* gmst00(<jdut>, <jdtt>)
...
BIND(iauGmst00, d_dT4_iDaDarDq_0011_2, f, gmst00, 2, 2, 0)
/*-----------------------------------------------------------------------*/
/* gmst06(<jdut>, <jdtt>)
...
BIND(iauGst00a, d_dT4_iDaDarDq_0011_2, f, gst00a, 2, 2, 0)
/*-----------------------------------------------------------------------*/
/* gst00b(<jdut>)
...
BIND(iauGst00b, d_dd_iDarDq_0z_1, f, gst00b, 1, 1, 0)
/*-----------------------------------------------------------------------*/
/* gst06(<jdut>, <jdtt>, <rnpb>)
   ...
   effects of precession.  If <jdtt> is set equal to <jdut> then
   errors of order 100 microarcseconds result. */
BIND(iauGst06, d_dT4dp3_iDaDaDp3p3arDq_00112_3, f, gst06, 3, 3, 0)
/*-----------------------------------------------------------------------*/
/* gst06a(<jdut>, <jdtt>)
...
BIND(iauH2fk5, v_dT6dpT6_iDaT6oDqT6_0T11, s, h2fk5, 12, 12, 0)
/*-----------------------------------------------------------------------*/
/* hfk5z, <rah>, <dech>, <jd>, <ra5>, <dec5>
   ...
   declination <dec5> */
BIND(iauHfk5z, v_dT4dpT4_iDaDaDoDqT4_0T2z3T6, s, hfk5z, 7, 7, 0)
/*-----------------------------------------------------------------------*/
/* ir()

   Returns an identity r-matrix */
BIND(iauIr, v_dp3_rD33_0, f, ir, 0, 0, 0)
/*-----------------------------------------------------------------------*/
...
BIND(iauJd2cal, iddipT3dp_iLarDp3q_0z1111, f, jd2cal, 1, 1, 0)
/*-----------------------------------------------------------------------*/
/* num00a(<jd>)

   Returns the matrix for nutation for a given Julian Date <jd>,
   according to the IAU 2000A model. */
BIND(iauNum00a, v_dddp3_iDarDp3p3q_0z1, f, num00a, 1, 1, 0)
/*-----------------------------------------------------------------------*/
/* num00b(<jd>)

   Returns the matrix for nutation for a given Julian Date <jd>,
   according to the IAU 2000B model. */
BIND(iauNum00b, v_dddp3_iDarDp3p3q_0z1, f, num00b, 1, 1, 0)
/*-----------------------------------------------------------------------*/
/* num06a(<jd>)

   Returns the matrix for nutation for a given Julian Date <jd>,
   according to the IAU 2006/2000A model. */
BIND(iauNum06a, v_dddp3_iDarDp3p3q_0z1, f, num06a, 1, 1, 0)
/*-----------------------------------------------------------------------*/
...
BIND(iauNut00a, v_dddpdp_iDaoDqDq_0z12, s, nut00a, 3, 3, 0)
/*-----------------------------------------------------------------------*/
/* nut00b, <jd>, <dpsi>, <deps>
...
BIND(iauNut00b, v_dddpdp_iDaoDqDq_0z12, s, nut00b, 3, 3, 0)
/*-----------------------------------------------------------------------*/
/* nut06a, <jd>, <dpsi>, <deps>
   ...
   + planetary) */
BIND(iauNut06a, v_dddpdp_iDaoDqDq_0z12, s, nut06a, 3, 3, 0)
/*-----------------------------------------------------------------------*/
/* nut80, <jd>, <dpsi>, <deps>
...
BIND(iauNut80, v_dddpdp_iDaoDqDq_0z12, s, nut80, 3, 3, 0)
/*-----------------------------------------------------------------------*/
/* nutm80(<jd>)
   ...
   IAU 1980 model.
 */
BIND(iauNutm80, v_dddp3_iDarDp3p3q_0z1, f, nutm80, 1, 1, 0)
/*-----------------------------------------------------------------------*/
/* obl06(<jd>)
 ...
 */
BIND(iauObl06, d_dd_iDarDq_0z_1, f, obl06, 1, 1, 0)
/*-----------------------------------------------------------------------*/
/* obl80(<jd>)

   Returns the mean obliquity of the ecliptic according to the IAU
   1980 model. */
BIND(iauObl80, d_dd_iDarDq_0z_1, f, obl80, 1, 1, 0)
/*-----------------------------------------------------------------------*/
/* p06e, <jd>, <eps0>, <psia>, <oma>, <bpa>, <bqa>, <pia>, <bpia>,
   ...
   F-W angle psi_J2000.
 */
BIND(iauP06e, v_dddpT16_iDaoDqT16_0z1T16, s, p06e, 17, 17, 0)
/*-----------------------------------------------------------------------*/
/* p2s(<p>)

   Returns the spherical polar coordinates (theta, phi, r)
   corresponding to the p-vector <p> */
BIND(iauP2s, v_dpT4_iD3arD3q_0111, f, p2s, 1, 1, 0)
/*-----------------------------------------------------------------------*/
/* pap(<ref>, <tgt>)

   Returns the position angle of p-vector <tgt> from p-vector <ref>
*/
BIND(iauPap, d_dpdp_iD3aD3qrDm3q_01_2, f, pap, 2, 2, 0)
/*-----------------------------------------------------------------------*/
/* pas(<al>, <ap>, <bl>, <bp>)
   ...
   point B in radians
*/
BIND(iauPas, d_dT4_iDaT4rDq_0T3_4, f, pas, 4, 4, 0)
/*-----------------------------------------------------------------------*/
...
BIND(iauPb06, v_dddpT3_iDaoDqT3_0z1T3, s, pb06, 4, 4, 0)
/*-----------------------------------------------------------------------*/
/* pdp(<a>, <b>)

   Returns the inner product of the two p-vectors <a> and <b> */
BIND(iauPdp, d_dpdp_iD3aD3qrDm3q_01_2, f, pdp, 2, 2, 0)
/*-----------------------------------------------------------------------*/
/* pfw06, <jd>, <gamb>, <phib>, <psib>, <epsa>

   Returns the IAU 2006 precession angles in Fukushima-Williams
   4-angle formulation. */
BIND(iauPfw06, v_dddpT4_iDaoDqT4_0z1T4, s, pfw06, 5, 5, 0)
/*-----------------------------------------------------------------------*/
/* plan94(<jd>, <planet>)
...
*/
BIND(iauPlan94, i_ddidp3_iDaL1rDp3p2q_0z12, f, plan94, 2, 2, 0)
/*-----------------------------------------------------------------------*/
/* pm(<p>)

   Returns the modulus of the p-vector <p>
*/
BIND(iauPm, d_dp_iD3arDm3q_0_1, f, pm, 1, 1, 0)
/*-----------------------------------------------------------------------*/
/* pmat00(<jd>)
...
*/
BIND(iauPmat00, v_dddp3_iDarDp3p3q_0z1, f, pmat00, 1, 1, 0)
/*-----------------------------------------------------------------------*/
/* pmat06(<jd>)
...
BIND(iauPn00, v_dT4dpdp3T5_iDaT3oDqDp3p3qT5_0z1T8, s, pn00, 9, 9, 0)
/*-----------------------------------------------------------------------*/
/* pn00a, <jd>, <dpsi>, <deps>, <epsa>, <rb>, <rp>, <rbp>, <rn>, <rbpn>
   ...
   <rb>, the precession matrix <rp>, the bias-precession matrix <rbp>,
   the nutation matrix <rn>, and the GCRS-to-true matrix <rbpn>. */
BIND(iauPn00a, v_dddpT3dp3T5_iDaoDqT3Dp3p3qT5_0z1T8, s, pn00a, 9, 9, 0)
/*-----------------------------------------------------------------------*/
/* pn00b, <jd>, <dpsi>, <deps>, <epsa>, <rb>, <rp>, <rbp>, <rn>, <rbpn>
   ...
   <rb>, the precession matrix <rp>, the bias-precession matrix <rbp>,
   the nutation matrix <rn>, and the GCRS-to-true matrix <rbpn>. */
BIND(iauPn00b, v_dddpT3dp3T5_iDaoDqT3Dp3p3qT5_0z1T8, s, pn00b, 9, 9, 0)
/*-----------------------------------------------------------------------*/
/* pn06, <jd>, <dpsi>, <deps>, <epsa>, <rb>, <rp>, <rbp>, <rn>, <rbpn>
   ...
   <rb>, the precession matrix <rp>, the bias-precession matrix <rbp>,
   the nutation matrix <rn>, and the GCRS-to-true matrix <rbpn>. */
BIND(iauPn06, v_dT4dpdp3T5_iDaT3oDqDp3p3qT5_0z1T8, s, pn06, 9, 9, 0)
/*-----------------------------------------------------------------------*/
/* pn06a, <jd>, <dpsi>, <deps>, <epsa>, <rb>, <rp>, <rbp>, <rn>, <rbpn>
   ...
   <rbpn>. */
BIND(iauPn06a, v_dddpT3dp3T5_iDaoDqT3Dp3p3qT5_0z1T8, s, pn06a, 9, 9, 0)
/*-----------------------------------------------------------------------*/
/* pnm00a(<jd>)

   Returns the matrix of precession-nutation (including frame bias)
   for Julian Date <jd>, equinox-based, IAU 2000A model. */
BIND(iauPnm00a, v_dddp3_iDarDp3p3q_0z1, f, pnm00a, 1, 1, 0)
/*-----------------------------------------------------------------------*/
/* pnm00b(<jd>)

   Returns the matrix of precession-nutation (including frame bias)
   for Julian Date <jd>, equinox-based, IAU 2000B model. */
BIND(iauPnm00b, v_dddp3_iDarDp3p3q_0z1, f, pnm00b, 1, 1, 0)
/*-----------------------------------------------------------------------*/
/* pnm06a(<jd>)
...
BIND(iauPnm06a, v_dddp3_iDarDp3p3q_0z1, f, pnm06a, 1, 1, 0)
/*-----------------------------------------------------------------------*/
/* pnm80(<jd>)
...
/* prec76, <jd1>, <jd2>, <zeta>, <z>, <theta>
   ...
   the y axis. */
BIND(iauPrec76, v_dT4dpT3_iDaDaoDqT3_0z1z2T4, s, prec76, 5, 5, 0)
/*-----------------------------------------------------------------------*/
...
BIND(iauPv2s, v_dp3dpT6_iD23aoDm2m3aDcT5_0T6, s, pv25, 7, 7, 0)
/*-----------------------------------------------------------------------*/
/* pvdpv(<a>, <b>)

   Returns the inner product of pv-vectors <a> and <b> */
BIND(iauPvdpv, v_dp3dp3dp_iD23aD23qoDcm3q_0T2, f, pvdpv, 2, 2, 0)
/*-----------------------------------------------------------------------*/
/* pvm, <pv>, <r>, <s>
   ...
   component. */
BIND(iauPvm, v_dp3dpdp_iD23aoDm2m3qDcq_0T2, s, pvm, 3, 3, 0)
/*-----------------------------------------------------------------------*/
/* pvstar, <pv>, <ra>, <dec>, <pmr>, <pmd>, <px>, <rv>
   ...
   receding) */
BIND(iauPvstar, i_dp3dpT6_iD23aoDm2m3aDcT5_0T6, s, pvstar, 7, 7, 0)
/*-----------------------------------------------------------------------*/
/* pvxpv(<a>, <b>)

   Returns the outer product of two pv-vectors <a> and <b> */
BIND(iauPvxpv, v_dp3T3_iD23aD23qoDcq_0T2, f, pvxpv, 2, 2, 0)
/*-----------------------------------------------------------------------*/
/* pxp(<a>, <b>)

   Returns the outer product of two p-vectors <a> and <b> */
BIND(iauPxp, v_dT3d3_iD3DcqrDcq_0T2, f, pxp, 2, 2, 0)
/*-----------------------------------------------------------------------*/
/* rm2v(<r>)
...
BIND(iauRm2v, v_dp3dp_iD33arDm3q_01, f, rm2v, 1, 1, 0)
/*-----------------------------------------------------------------------*/
/* rxp(<r>, <p>)

   Returns the matrix product of an r-matrix and a p-vector. */
BIND(iauRxp, v_dp3dpdp_iD33aDm3arDcq_0T2, f, rxp, 2, 2, 0)
/*-----------------------------------------------------------------------*/
/* rxr(<r1>, <r2>)

   Returns the matrix product of two r-matrices. */
BIND(iauRxr, v_dp3T3_iD33aDarDq_0T2, f, rxr, 2, 2, 0)
/*-----------------------------------------------------------------------*/
/* rv2m(<w>)
   ...
   <w>. */
BIND(iauRv2m, v_dpdp3_iD3arDp3q_01, f, rv2m, 1, 1, 0)
/*-----------------------------------------------------------------------*/
/* rx, <phi>, <r>

   Rotates r-matrix <r> about the x axis over angle <phi> */
BIND(iauRx, v_ddp3_iD1D33_01, s, rx, 2, 2, 0)
/*-----------------------------------------------------------------------*/
/* rxpv(<r>, <pv>)

   Returns the matrix product of r-matrix <r> and pv-vector <pv> */
BIND(iauRxpv, v_dp3T3_iD33aDaoDc_0T2, f, rxpv, 2, 2, 0)
/*-----------------------------------------------------------------------*/
/* ry, <phi>, <r>

   Rotates r-matrix <r> about the y axis over angle <phi> */
BIND(iauRy, v_ddp3_iD1D33_01, s, ry, 2, 2, 0)
/*-----------------------------------------------------------------------*/
/* rz, <phi>, <r>

   Rotates r-matrix <r> about the z axis over angle <phi> */
BIND(iauRz, v_ddp3_iD1D33_01, s, rz, 2, 2, 0)
/*-----------------------------------------------------------------------*/
/* s00(<jd>, <x>, <y>)
   ...
   precession-nutation */
BIND(iauS00, d_dT4_iLaDaDarDq_0z12, f, s00, 3, 3, 0)
/*-----------------------------------------------------------------------*/
/* s00a(<jd>)

   Returns the CIO locator for the specified Julian Date <jd>, using
   IAU 2000A precession-nutation */
BIND(iauS00a, d_dd_iDarDq_0z_1, f, s00a, 1, 1, 0)
/*-----------------------------------------------------------------------*/
/* s00b(<jd>)

   Returns the CIO locator for the specified Julian Date <jd>, using
   IAU 2000B precession-nutation */
BIND(iauS00b, d_dd_iDarDq_0z_1, f, s00b, 1, 1, 0)
/*-----------------------------------------------------------------------*/
/* s06(<jd>, <x>, <y>)
   ...
   precession-nutation */
BIND(iauS06, d_dT4_iLaDaDarDq_0z12, f, s06, 3, 3, 0)
/*-----------------------------------------------------------------------*/
/* s06a(<jd>)

   Returns the CIO locator for the specified Julian Date <jd>, using
   IAU 2006 precession and IAU 2000A nutation */
BIND(iauS06a, d_dd_iDarDq_0z_1, f, s06a, 1, 1, 0)
/*-----------------------------------------------------------------------*/
/* s2c(<theta>, <phi>)
...
/* s2pv(<theta>, <phi>, <r>, <td>, <pd>, <rd>)
   ...
   r <rd> */
BIND(iauS2pv, v_dT6dp3_iDaT6oDp2p3q_0T6, f, s2pv, 6, 6, 0)
/*-----------------------------------------------------------------------*/
/* sepp(<a>, <b>)

   Returns the angular separation between two p-vectors <a> and <b> */
BIND(iauSepp, d_dpdp_iD3aD3qrDm3q_01_2, f, sepp, 2, 2, 0)
/*-----------------------------------------------------------------------*/
/* seps(<lon1>, <lat1>, <lon2>, <lat2>)
   ...
   latitude <lat2> */
BIND(iauSeps, d_dT4_iDaT4rDq_0T3_4, f, seps, 4, 4, 0)
/*-----------------------------------------------------------------------*/
/* sp00(<jd>)
   ...
   Intermediate Pole */
BIND(iauSp00, d_dd_iDarDq_0z_1, f, sp00, 1, 1, 0)
/*-----------------------------------------------------------------------*/
/* starpm, <ra1>, <dec1>, <pmr1>, <pmd1>, <px1>, <rv1>, <jd1>,
   ...
   *1 = before, *2 = after */
BIND(iauStarpm, i_dT10dpT6_iDaT8oDqT6_0T6z7z8T13, s, starpm, 14, 14, 0)
/*-----------------------------------------------------------------------*/
/* starpv(<ra>, <dec>, <pmr>, <pmd>, <px>, <rv>)

   Converts star catalog coordinates to a position-velocity matrix */
BIND(iauStarpv, i_dT6dp3_iDaT6oDp2p3q_0T6, f, starpv, 6, 6, 0)
/*-----------------------------------------------------------------------*/
/* taitt(<jdtai>)

   Translates Julian Date <jdtai> from TAI to TT */
BIND(iauTaitt, i_dddpdp_iDarDq_0z11, f, taitt, 1, 1, 0)
/*-----------------------------------------------------------------------*/
/* taiut1(<jdtai>, <dta>)

   Translates Julian Date <jdtai> from TAI to UT1, given <dta> = UT1 -
   TAi in seconds */
BIND(iauTaiut1, i_dT3dpdp_iDaDarDq_0z122, f, taiut1, 2, 2, 0)
/*-----------------------------------------------------------------------*/
/* taiutc(<jdtai>)

   Translates Julian Date <jdtai> from TAI to UTC */
BIND(iauTaiutc, i_dddpdp_iDarDq_0z11, f, taiutc, 1, 1, 0)
/*-----------------------------------------------------------------------*/
/* tcbtdb(<jdtcb>)

   Translates Julian Date <jdtcb> from TCB to TDB */
BIND(iauTcbtdb, i_dddpdp_iDarDq_0z11, f, tcbtdb, 1, 1, 0)
/*-----------------------------------------------------------------------*/
/* tcgtt(<jdtcg>)

   Translates Julian Date <jdtcg> from TCG to TT */
BIND(iauTcgtt, i_dddpdp_iDarDq_0z11, f, tcgtt, 1, 1, 0)
/*-----------------------------------------------------------------------*/
/* tdbtcb(<jdtdb>)

   Translates Julian Date <jdtdb> from TDB to TCB */
BIND(iauTdbtcb, i_dddpdp_iDarDq_0z11, f, tdbtcb, 1, 1, 0)
/*-----------------------------------------------------------------------*/
/* tdbtt(<jdtdb>, <dtr>)

   Translates Julian Date <jdtbd> from TDB to TT, given <dtr> = TDB -
   TT in seconds  */
BIND(iauTdbtt, i_dT3dpdp_iDaDarDq_0z122, f, tdbtt, 2, 2, 0)
/*-----------------------------------------------------------------------*/
/* tr(<r>)

   Transposes r-matrix <r> */
BIND(iauTr, v_dp3dp3_iD33arDq_01, f, tr, 1, 1, 0)
/*-----------------------------------------------------------------------*/
/* trxp(<r>, <p>)

   Multiply p-vector <p> by the transpose of r-matrix <r> */
BIND(iauTrxp, v_dp3dpdp_iD33aDm3arDcq_0T2, f, trxp, 2, 2, 0)
/*-----------------------------------------------------------------------*/
/* trxpv(<r>, <pv>)

   Multiply pv-vector <pv> by the transpose of r-matrix <r> */
BIND(iauTrxpv, v_dp3T3_iD33aDaoDc_0T2, f, trxpv, 2, 2, 0)
/*-----------------------------------------------------------------------*/
/* tttai(<jdtt>)

   Transforms Julian Date <jdtt> from TT to TAI */
BIND(iauTttai, i_dddpdp_iDarDq_0z11, f, tttai, 1, 1, 0)
/*-----------------------------------------------------------------------*/
/* tttcg(<jdtt>)

   Transforms Julian Date <jdtt> from TT to TCG */
BIND(iauTttcg, i_dddpdp_iDarDq_0z11, f, tttcg, 1, 1, 0)
/*-----------------------------------------------------------------------*/
/* tttdb(<jdtt>, <dt>)

   Transforms Julian Date <jdtt> from TT to TDB, given <dt> = TDB -
   TT in seconds */
BIND(iauTttdb, i_dT3dpdp_iDaDarDq_0z122, f, tttdb, 2, 2, 0)
/*-----------------------------------------------------------------------*/
/* ttut1(<jdtt>, <dt>)

   Transforms Julian Date <jdtt> from TT to UT1, given <dt> = TT - UT1
   in seconds */
BIND(iauTtut1, i_dT3dpdp_iDaDarDq_0z122, f, ttut1, 2, 2, 0)
/*-----------------------------------------------------------------------*/
/* ut1tai(<jdut>, <dt>)

   Transforms Julian Date <jdut> from UT1 to TAI, given <dt> = UT1 -
   TAI in seconds */
BIND(iauUt1tai, i_dT3dpdp_iDaDarDq_0z122, f, ut1tai, 2, 2, 0)
/*-----------------------------------------------------------------------*/
/* ut1tt(<jdut>, <dt>)

   Transforms Julian Date <jdut> from UT1 to TT, given <dt> = UT1 -
   TT in seconds */
BIND(iauUt1tt, i_dT3dpdp_iDaDarDq_0z122, f, ut1tt, 2, 2, 0)
/*-----------------------------------------------------------------------*/
/* ut1utc(<jdut>, <dt>)

   Transforms Julian Date <jdut> from UT1 to UTC, given <dt> = UT1 -
   UTC in seconds */
BIND(iauUt1utc, i_dT3dpdp_iDaDarDq_0z122, f, ut1utc, 2, 2, 0)
/*-----------------------------------------------------------------------*/
/* utctai(<jdut>)

   Transforms Julian Date <jdut> from UTC to TAI */
BIND(iauUtctai, i_dddpdp_iDarDq_0z11, f, utctai, 1, 1, 0)
/*-----------------------------------------------------------------------*/
/* utcut1(<jdut>, <dt>)

   Transforms Julian Date <jdut> from UTC to UT1, given <dt> = UT1 -
   UTC in seconds */
BIND(iauUtcut1, i_dT3dpdp_iDaDarDq_0z122, f, utcut1, 2, 2, 0)
/*-----------------------------------------------------------------------*/
/* xy06, <jd>, <x>, <y>
   ...
   2000A nutation. */
BIND(iauXy06, v_dddpdp_iDaoDqDq_0z12, s, xy06, 3, 3, 0)
/*-----------------------------------------------------------------------*/
/* xys00a, <jd>, <x>, <y>, <s>
...
BIND(iauXys00a, v_dddpT3_iDaoDqT3_0z1T3, s, xys00a, 4, 4, 0)
/*-----------------------------------------------------------------------*/
/* xys00b, <jd>, <x>, <y>, <s>
   ...
   precession-nutation model */
BIND(iauXys00b, v_dddpT3_iDaoDqT3_0z1T3, s, xys00b, 4, 4, 0)
/*-----------------------------------------------------------------------*/
/* xys06a, <jd>, <x>, <y>, <s>
...
BIND(iauXys06a, v_dddpT3_iDaoDqT3_0z1T3, s, xys06a, 4, 4, 0)
/*-----------------------------------------------------------------------*/
