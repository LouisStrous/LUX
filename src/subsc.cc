...
int32_t         lux_assoc_output(int32_t iq, int32_t jq, int32_t offsym, int32_t axsym),
  ...
  lux_gmap(ArgumentCount narg, Symbol ps[], Symboltype new_type), lux_assoc_input(int32_t, int32_t []),
  simple_reverse(int32_t *p1, int32_t *p2, int32_t n, int32_t type), getBody(int32_t),
  string_sub(int32_t, int32_t []);
//-------------------------------------------------------------------------
int32_t lux_inserter(ArgumentCount narg, Symbol ps[])
...
//-------------------------------------------------------------------------
int32_t lux_smap(ArgumentCount narg, Symbol ps[])
...
int32_t lux_reverse(ArgumentCount narg, Symbol ps[])
...
int32_t lux_subsc_func(ArgumentCount narg, Symbol ps[])
...
// rewritten LS 6aug96
{
 ...
 //-------------------------------------------------------------------------
int32_t string_sub(ArgumentCount narg, Symbol ps[])
 ...
 LS 19aug98 */
{
 ...
 //-------------------------------------------------------------------------
int32_t lux_symclass(ArgumentCount narg, Symbol ps[])
    ...
    LS 13may92 */
{
 ...
 //-------------------------------------------------------------------------
int32_t lux_symdtype(ArgumentCount narg, Symbol ps[])
 //return the type of the argument symbol
{
 ...
 //-------------------------------------------------------------------------
int32_t lux_num_elem(ArgumentCount narg, Symbol ps[])
...
//-------------------------------------------------------------------------
int32_t lux_num_dimen(ArgumentCount narg, Symbol ps[])
 //return the number of dimensions in the argument symbol
{
 ...
 //-------------------------------------------------------------------------
int32_t lux_dimen(ArgumentCount narg, Symbol ps[])
...
// specified, then all dimensions are returned.  LS 19may98
{
 ...
 //-------------------------------------------------------------------------
int32_t lux_redim_f(ArgumentCount narg, Symbol ps[])
 // redimension an array, a function version, returns input symbol
{
 ...
 //-------------------------------------------------------------------------
int32_t lux_redim(ArgumentCount narg, Symbol ps[])
     ...
     // for me elsewhere.  LS 19may97
{
 ...
 //-------------------------------------------------------------------------
int32_t lux_concat_list(ArgumentCount narg, Symbol ps[])
...
copyScalarToArray(int32_t src, Pointer tgt, Symboltype tgttype)
{
 ...
 //-------------------------------------------------------------------------
int32_t lux_concat(ArgumentCount narg, Symbol ps[])
    ...
    for (i = 0; i < narg; i++) {
      ...
      if (n)
        ...
        case LUX_INT64:
          ...
          case LUX_INT8:
            while (n--)
              *q2.i64++ = (int64_t) *q1.ui8++;
            break;
          case LUX_INT16:
            while (n--)
              *q2.i64++ = (int64_t) *q1.i16++;
            break;
          case LUX_INT32:
            while (n--)
              *q2.i64++ = (int64_t) *q1.i32++;
            break;
          case LUX_INT64:
            while (n--)
              *q2.i64++ = *q1.i64++;
...
//-------------------------------------------------------------------------
int32_t lux_roll(ArgumentCount narg, Symbol ps[])
