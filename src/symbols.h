...
#define block_num_statements(symbol) /* Int */(sym[symbol].spec.wlist.bstore/sizeof(int16_t))
#define block_statements(symbol) /* int16_t * */(sym[symbol].spec.wlist.ptr)
#define case_num_statements(symbol) /* Int */(sym[symbol].spec.wlist.bstore/sizeof(int16_t))
#define case_statements(symbol) /* int16_t * */(sym[symbol].spec.wlist.ptr)
#define clist_depth(symbol)	/* uint8_t */(sym[symbol].type)
#define clist_num_symbols(symbol) /* Int */(sym[symbol].spec.wlist.bstore/sizeof(int16_t))
...
#define evb_num_elements(symbol) /* Int */(sym[symbol].spec.wlist.bstore/sizeof(int16_t))
...
#define insert_num_target_indices(symbol) /* Int */(sym[symbol].spec.wlist.bstore/sizeof(int16_t) - 1)
...
#define int_func_num_arguments(symbol)	/* Int */(sym[symbol].spec.wlist.bstore/sizeof(int16_t))
#define int_func_number(symbol) /* int16_t */(sym[symbol].xx)
#define int_sub_arguments(symbol) /* int16_t * */(sym[symbol].spec.wlist.ptr)
#define int_sub_num_arguments(symbol) /* Int */(sym[symbol].spec.wlist.bstore/sizeof(int16_t))
...
#define ncase_num_statements(symbol) /* Int */(sym[symbol].spec.wlist.bstore/sizeof(int16_t) - 2)
...
#define pre_clist_num_symbols(symbol) /* Int */(sym[symbol].spec.wlist.bstore/sizeof(int16_t))
...
#define usr_func_num_arguments(symbol) /* Int */(sym[symbol].spec.wlist.bstore/sizeof(int16_t))
#define usr_func_number(symbol) /* int16_t */(sym[symbol].xx)
#define usr_routine_arguments(symbol) /* int16_t * */(sym[symbol].spec.wlist.ptr)
#define usr_routine_num_arguments(symbol) /* Int */(sym[symbol].spec.wlist.bstore/sizeof(int16_t))
...
#define usr_sub_num_arguments(symbol) /* Int */(sym[symbol].spec.wlist.bstore/sizeof(int16_t))
