     ...
     // error, then set this synchronization.
{
 ...
 //--------------------------------------------------------------------------
int32_t lux_show_visuals(ArgumentCount narg, Symbol ps[])
{
...
//--------------------------------------------------------------------------
int32_t lux_xclose(ArgumentCount narg, Symbol ps[])
   ...
   or the window does not exist, then 0 is returned.  LS 16apr93 */
{
 ...
 //--------------------------------------------------------------------------
int32_t lux_xtvlct(ArgumentCount narg, Symbol ps[])
...
//--------------------------------------------------------------------------
int32_t lux_xopen(ArgumentCount narg, Symbol ps[])
...
//--------------------------------------------------------------------------
int32_t lux_xexist(ArgumentCount narg, Symbol ps[])// return 1 if window exists
 // argument is port #
{
  int32_t     wid;
...
//--------------------------------------------------------------------------
int32_t lux_xport(ArgumentCount narg, Symbol ps[])        // open a window or pixmap
...
//--------------------------------------------------------------------------
int32_t lux_xsetinputs(ArgumentCount narg, Symbol ps[])                // set the input mask
{
  int32_t        wid;
 ...
 //-------------------------------------------------------------------------
int32_t lux_xcursor(ArgumentCount narg, Symbol ps[]) // set the cursor
{
  int32_t    wid, iq;
  Cursor cursor;
  XColor        *cfore, *cback;
...
//--------------------------------------------------------------------------
int32_t lux_xsetbackground(ArgumentCount narg, Symbol ps[])// set the background color
...
//--------------------------------------------------------------------------
int32_t lux_xsetforeground(ArgumentCount narg, Symbol ps[])// set the foreground color
...
//--------------------------------------------------------------------------
int32_t lux_xdelete(ArgumentCount narg, Symbol ps[]) // delete a window or a pixmap
{
  int32_t    wid;
 ...
 //--------------------------------------------------------------------------
int32_t lux_xerase(ArgumentCount narg, Symbol ps[])
     // erase a window
     // pixmap support added.  LS 8oct97
{
 ...
 //------------------------------------------------------------------------
int32_t lux_xsetaction(ArgumentCount narg, Symbol ps[])
...
//------------------------------------------------------------------------
int32_t lux_xtv_general(ArgumentCount narg, Symbol ps[], int32_t mode)
{
  Pointer        data;
...
//------------------------------------------------------------------------
int32_t lux_xtvraw(ArgumentCount narg, Symbol ps[])
      ...
      if (mode & TV_24) {                // three bytes per pixel
        switch (type) {
          ...
          case LUX_INT16:
            ...
            for (iy = y1; iy <= y2; iy++)
              for (ix = x1; ix <= x2; ix++) {
                value.i16 = data.i16[ix + iy*nx];
                if (value.i16 < min.i16)
                  min.i16 = value.i16;
                if (value.i16 > max.i16)
                  max.i16 = value.i16;
                value.i16 = data.i16[ix + iy*nx + s];
                if (value.i16 < min.i16)
                  min.i16 = value.i16;
                if (value.i16 > max.i16)
                  max.i16 = value.i16;
                value.i16 = data.i16[ix + iy*nx + 2*s];
                if (value.i16 < min.i16)
                  min.i16 = value.i16;
                if (value.i16 > max.i16)
                  max.i16 = value.i16;
            ...
            if (max.i16 == min.i16)
              ...
              factor.f = (256/3)/((float) max.i16 - min.i16);
            else
              factor.f = 255/((float) max.i16 - min.i16);
            offset.f = (float) min.i16;
            break;
          case LUX_INT32:
            min.i32 = INT32_MAX;
            max.i32 = -INT32_MAX;
            for (iy = y1; iy <= y2; iy++)
              for (ix = x1; ix <= x2; ix++) {
                value.i32 = data.i32[ix + iy*nx];
                if (value.i32 < min.i32)
                  min.i32 = value.i32;
                if (value.i32 > max.i32)
                  max.i32 = value.i32;
                value.i32 = data.i32[ix + iy*nx + s];
                if (value.i32 < min.i32)
                  min.i32 = value.i32;
                if (value.i32 > max.i32)
                  max.i32 = value.i32;
                value.i32 = data.i32[ix + iy*nx + 2*s];
                if (value.i32 < min.i32)
                  min.i32 = value.i32;
                if (value.i32 > max.i32)
                  max.i32 = value.i32;
            ...
            if (max.i32 == min.i32)
              ...
              factor.f = (256/3)/((float) max.i32 - min.i32);
            else
              factor.f = 255/((float) max.i32 - min.i32);
        ...
        switch (type) {
          ...
          case LUX_INT16:
            ...
            if (max.i16 == min.i16)
              ...
              factor.f = ((float) scalemax - scalemin)/((float) max.i16 - min.i16);
            offset.f = (float) min.i16;
            break;
          case LUX_INT32:
            min.i32 = INT32_MAX;
            ...
            if (max.i32 == min.i32)
              ...
              factor.f = ((float) scalemax - scalemin)/((float) max.i32 - min.i32);
            offset.f = (float) min.i32;
            break;
          case LUX_INT64:
            min.i64 = INT64_MAX;
                ...
                switch (bpp) {
                  case 8:
                    *image.ui8 = (pixels[indx] & red_mask);
                    break;
                  case 16:
                    *image.i16 = (pixels[indx] & red_mask);
                    break;
                  case 32:
                ...
                switch (bpp) {
                  case 8:
                    *image.ui8 |= (pixels[indx] & green_mask);
                    break;
                  case 16:
                    *image.i16 |= (pixels[indx] & green_mask);
                    break;
                  case 32:
                ...
                switch (bpp) {
                  case 8:
                    *image.ui8++ |= (pixels[indx] & blue_mask);
                    break;
                  case 16:
                    *image.i16++ |= (pixels[indx] & blue_mask);
                    break;
                  case 32:
                    *image.i32++ |= (pixels[indx] & blue_mask);
                    break;
                } // end of switch (bpp)
              }        // end of for (ix...)
            break;
          case LUX_INT16:
            for (iy = 0; iy < nyy; iy--)
              for (ix = 0; ix < nxx; ix++) {
                xsrc = x1 + ix/magx;
                ysrc = y1 + iy/magy;
                indx = (data.i16[xsrc + ysrc*nx] - offset.f)*factor.f;
                if (indx < scalemin)
                  indx = scalemin;
                else if (indx > scalemax)
                  indx = scalemax;
                ...
                indx = (data.i16[xsrc + ysrc*nx + s] - offset.f)*factor.f;
                if (indx < scalemin)
                  indx = scalemin;
                else if (indx > scalemax)
                  indx = scalemax;
                ...
                indx = (data.i16[xsrc + ysrc*nx + 2*s] - offset.f)*factor.f;
                if (indx < scalemin)
                  indx = scalemin;
                else if (indx > scalemax)
                  indx = scalemax;
          ...
          case LUX_INT32:
            for (iy = 0; iy < nyy; iy--)
              for (ix = 0; ix < nxx; ix++) {
                xsrc = x1 + ix/magx;
                ysrc = y1 + iy/magy;
                indx = (data.i32[xsrc + ysrc*nx] - offset.f)*factor.f;
                if (indx < scalemin)
                  indx = scalemin;
                else if (indx > scalemax)
                  indx = scalemax;
                ...
                indx = (data.i32[xsrc + ysrc*nx + s] - offset.f)*factor.f;
                if (indx < scalemin)
                  indx = scalemin;
                else if (indx > scalemax)
                  indx = scalemax;
                ...
                indx = (data.i32[xsrc + ysrc*nx + 2*s] - offset.f)*factor.f;
                if (indx < scalemin)
                  indx = scalemin;
                else if (indx > scalemax)
                  indx = scalemax;
                ...
                switch (bpp) {
                  case 8:
                    *image.ui8++ = toscreen? pixels[indx]: indx;
                    break;
                  case 16:
                    *image.i16++ = toscreen? pixels[indx]: indx;
                    break;
                  case 32:
                    *image.i32++ = toscreen? pixels[indx]: indx;
                    break;
                } // end of switch (bpp)
              }        // end of for (ix...)
            break;
            ...
            switch (bpp) {
              case 8:
                *image.ui8++ = (data.ui8[xsrc + ysrc*nx] & red_mask)
                ...
                break;
              case 16:
                *image.i16++ = (data.i16[xsrc + ysrc*nx] & red_mask)
                  | (data.i16[xsrc + ysrc*nx + s] & green_mask)
                  | (data.i16[xsrc + ysrc*nx + 2*s] & blue_mask);
                break;
              case 32:
                *image.i32++ = (data.i32[xsrc + ysrc*nx] & red_mask)
                  | (data.i32[xsrc + ysrc*nx + s] & green_mask)
                  | (data.i32[xsrc + ysrc*nx + 2*s] & blue_mask);
                break;
            } // end of switch (bpp)
          } // end of for (ix)
      }        // end of if (mode & TV_24)
            ...
            switch (bpp) {
              case 8:
                *image.ui8++ = data.ui8[xsrc + ysrc*nx];
                break;
              case 16:
                *image.i16++ = data.i16[xsrc + ysrc*nx];
                break;
              case 32:
                *image.i32++ = data.i32[xsrc + ysrc*nx];
                break;
            } // end of switch (bpp)
          } // end of for (ix)
      }        // end of if (mode & TV_24) else
...
/*    if (!XInitImage(xi))
 ...
 //------------------------------------------------------------------------
int32_t lux_colorpixel(ArgumentCount narg, Symbol ps[])
// maps color indices to pixel values
{
    ...
    case 8:
      if (internalMode & TV_24)
        switch (symbol_type(*ps)) {
          ...
          case LUX_INT16:
            while (n--)
              *q.ui8++ = (pixels[(int32_t) *p.i16] & red_mask)
                | (pixels[(int32_t) p.i16[n]] & green_mask)
                | (pixels[(int32_t) p.i16[2*n]] & blue_mask);
            break;
          case LUX_INT32:
            while (n--)
              *q.ui8++ = (pixels[(int32_t) *p.i32] & red_mask)
                | (pixels[(int32_t) p.i32[n]] & green_mask)
                | (pixels[(int32_t) p.i32[2*n]] & blue_mask);
            break;
          case LUX_INT64:
            while (n--)
          ...
          case LUX_INT16:
            while (n--)
              *q.ui8++ = pixels[(int32_t) ((uint8_t) *p.i16++)];
            break;
          case LUX_INT32:
            while (n--)
              *q.ui8++ = pixels[(int32_t) ((uint8_t) *p.i32++)];
            break;
          case LUX_INT64:
            while (n--)
    ...
    case 16:
      if (internalMode & TV_24)
        switch (symbol_type(*ps)) {
          case LUX_INT8:
            while (n--)
              *q.i16++ = (pixels[(int32_t) *p.ui8] & red_mask)
                | (pixels[(int32_t) p.ui8[n]] & green_mask)
                | (pixels[(int32_t) p.ui8[2*n]] & blue_mask);
            break;
          case LUX_INT16:
            while (n--)
              *q.i16++ = (pixels[(int32_t) *p.i16] & red_mask)
                | (pixels[(int32_t) p.i16[n]] & green_mask)
                | (pixels[(int32_t) p.i16[2*n]] & blue_mask);
            break;
          case LUX_INT32:
            while (n--)
              *q.i16++ = (pixels[(int32_t) *p.i32] & red_mask)
                | (pixels[(int32_t) p.i32[n]] & green_mask)
                | (pixels[(int32_t) p.i32[2*n]] & blue_mask);
            break;
          case LUX_INT64:
          ...
          case LUX_FLOAT:
            while (n--)
              *q.i16++ = (pixels[(int32_t) *p.f] & red_mask)
                | (pixels[(int32_t) p.f[n]] & green_mask)
                | (pixels[(int32_t) p.f[2*n]] & blue_mask);
            break;
          case LUX_DOUBLE:
            while (n--)
              *q.i16++ = (pixels[(int32_t) *p.d] & red_mask)
                | (pixels[(int32_t) p.d[n]] & green_mask)
                | (pixels[(int32_t) p.d[2*n]] & blue_mask);
            break;
        } else switch (symbol_type(*ps)) {
          case LUX_INT8:
            while (n--)
              *q.i16++ = pixels[(int32_t) *p.ui8++];
            break;
          case LUX_INT16:
            while (n--)
              *q.i16++ = pixels[(int32_t) ((uint8_t) *p.i16++)];
            break;
          case LUX_INT32:
            while (n--)
              *q.i16++ = pixels[(int32_t) ((uint8_t) *p.i32++)];
            break;
          case LUX_INT64:
            while (n--)
          ...
          case LUX_FLOAT:
            while (n--)
              *q.i16++ = pixels[(int32_t) ((uint8_t) *p.f++)];
            break;
          case LUX_DOUBLE:
            while (n--)
              *q.i16++ = pixels[(int32_t) ((uint8_t) *p.d++)];
            break;
        }
      break;
    case 24:
      if (internalMode & TV_24)
        switch (symbol_type(*ps)) {
          case LUX_INT8:
            while (n--)
              *q.i32++ = (pixels[(int32_t) *p.ui8] & red_mask)
                | (pixels[(int32_t) p.ui8[n]] & green_mask)
                | (pixels[(int32_t) p.ui8[2*n]] & blue_mask);
            break;
          case LUX_INT16:
            while (n--)
              *q.i32++ = (pixels[(int32_t) *p.i16] & red_mask)
                | (pixels[(int32_t) p.i16[n]] & green_mask)
                | (pixels[(int32_t) p.i16[2*n]] & blue_mask);
            break;
          case LUX_INT32:
            while (n--)
              *q.i32++ = (pixels[(int32_t) *p.i32] & red_mask)
                | (pixels[(int32_t) p.i32[n]] & green_mask)
                | (pixels[(int32_t) p.i32[2*n]] & blue_mask);
            break;
          case LUX_INT64:
          ...
          case LUX_FLOAT:
            while (n--)
              *q.i32++ = (pixels[(int32_t) *p.f] & red_mask)
                | (pixels[(int32_t) p.f[n]] & green_mask)
                | (pixels[(int32_t) p.f[2*n]] & blue_mask);
            break;
          case LUX_DOUBLE:
            while (n--)
              *q.i32++ = (pixels[(int32_t) *p.d] & red_mask)
                | (pixels[(int32_t) p.d[n]] & green_mask)
                | (pixels[(int32_t) p.d[2*n]] & blue_mask);
            break;
        } else switch (symbol_type(*ps)) {
          case LUX_INT8:
            while (n--)
              *q.i32++ = pixels[(int32_t) *p.ui8++];
            break;
          case LUX_INT16:
            while (n--)
              *q.i32++ = pixels[(int32_t) ((uint8_t) *p.i16++)];
            break;
          case LUX_INT32:
            while (n--)
              *q.i32++ = pixels[(int32_t) ((uint8_t) *p.i32++)];
            break;
          case LUX_INT64:
            while (n--)
          ...
          case LUX_FLOAT:
            while (n--)
              *q.i32++ = pixels[(int32_t) ((uint8_t) *p.f++)];
            break;
          case LUX_DOUBLE:
            while (n--)
              *q.i32++ = pixels[(int32_t) ((uint8_t) *p.d++)];
            break;
        }
      break;
  }
 ...
 //------------------------------------------------------------------------
int32_t lux_xtv(ArgumentCount narg, Symbol ps[])
   ...
   LS 18jan94 */
{
 ...
 //------------------------------------------------------------------------
int32_t lux_xtvmap(ArgumentCount narg, Symbol ps[])
  ...
  on screen.  LS 18jan94 */
{
 ...
 //------------------------------------------------------------------------
int32_t lux_xcopy(ArgumentCount narg, Symbol ps[])
 ...
 //------------------------------------------------------------------------
int32_t lux_xevent(ArgumentCount narg, Symbol ps[])
{
 XEvent  report;
 int32_t     nev, i;
 ...
 //------------------------------------------------------------------------
int32_t lux_xpurge(ArgumentCount narg, Symbol ps[]) // just throw away any pending X events
 {
 XEvent  report;
 int32_t     nev, i;
 ...
 //------------------------------------------------------------------------
int32_t lux_xplace(ArgumentCount narg, Symbol ps[])
...
// added alternateDash - LS 16oct98
{
 ...
 //------------------------------------------------------------------------
int32_t lux_xflush(ArgumentCount narg, Symbol ps[])
 {
...
// LS 12jul94
 ...
 //------------------------------------------------------------------------
int32_t lux_xfont(ArgumentCount narg, Symbol ps[])
 ...
 ck_events();
 iq = ps[0];
 if (symbol_class(iq) != 2) return cerror(NEED_STR, iq);
 ...
 //------------------------------------------------------------------------
int32_t lux_xlabel(ArgumentCount narg, Symbol ps[])
                                        // user labels
 {
 ...
 //------------------------------------------------------------------------
int32_t lux_xlabelwidth(ArgumentCount narg, Symbol ps[])
                                        // user label width
 {
 ...
 ck_events();
 iq = ps[0];
 if (symbol_class(iq) != LUX_STRING) return cerror(NEED_STR, iq);
 s = (char *) sym[iq].spec.array.ptr;
 len = sym[iq].spec.array.bstore - 1;
 wid = last_wid;
                                        ...
                                        // internal call for labels
{
 ...
 //------------------------------------------------------------------------
int32_t xlabelwidth(char const* s)
                                        // internal call for labels
 {
 int32_t     len, wid;
 len = strlen(s);
 ...
 //------------------------------------------------------------------------
int32_t lux_xtvread(ArgumentCount narg, Symbol ps[])
{
...
//------------------------------------------------------------------------
int32_t lux_xquery(ArgumentCount narg, Symbol ps[])
{
 ...
 //------------------------------------------------------------------------
int32_t lux_xquery_f(ArgumentCount narg, Symbol ps[])
{
 int32_t        result;
 int32_t        xquery(int32_t, int32_t []);

 result = scalar_scratch(LUX_INT32);
 sym[result].spec.scalar.i32 = xquery(narg, ps);
 return result;
}
//------------------------------------------------------------------------
int32_t xquery(ArgumentCount narg, Symbol ps[])
...
//------------------------------------------------------------------------
int32_t lux_check_window(ArgumentCount narg, Symbol ps[])
...
//------------------------------------------------------------------------
int32_t lux_xraise(ArgumentCount narg, Symbol ps[]) // raise (popup) a window
{
  int32_t    wid;
...
//------------------------------------------------------------------------
int32_t lux_xanimate(ArgumentCount narg, Symbol ps[])
...
// /REPEAT]
{
  ...
  if (fr1 < 0 || fr1 >= nFrame - 1)
    return luxerror("Start frame number out of range: %1d vs. (0:%1d)",
                 ps[3], fr1, 0, nFrame - 2);
  data.i32 = (int32_t*) array_data(ps[0]);
  ix = 0;
  iy = 0;
  if (narg > 4 && ps[4])
    fr2 = int_arg(ps[4]);
...
//---------------------------------------------------------
int32_t lux_xzoom(ArgumentCount narg, Symbol ps[])
// ZOOM,image [,x,y,window]
{
  ...
  ptr.i32 = (int32_t*) array_data(ps[0]);
  type = array_type(ps[0]);
...
int32_t lux_xtvplane(ArgumentCount narg, Symbol ps[])
 ...
 // can't be too big
  ...
  if (tvplanezoom != 1) {
    ...
    /* get pointer to this now, assume that ns and ms are the proper
       dimension */
    ptr = (uint8_t*) array_data(zoom_sym);
    nx = ns;
    ny = ms;
  }
  ...
  if (!subfree)
    /* we're looking at the original image, which we are not supposed
       to modify */
    subfree = ptr2 = (uint8_t*) malloc(nx*ny);
  else
    ptr2 = ptr;
...
//---------------------------------------------------------
int32_t lux_threecolors(ArgumentCount narg, Symbol ps[])
   ...
   LS 12nov98 */
{
  ...
  list = (float*) array_data(lux_float(1, ps));
  return threecolors(list, 9);
}
//---------------------------------------------------------
int32_t lux_tv3(ArgumentCount narg, Symbol ps[])
...
int32_t lux_xdrawline(ArgumentCount narg, Symbol ps[])
...
//---------------------------------------------------------
int32_t lux_xinvertline(ArgumentCount narg, Symbol ps[])
// used for X window drawing with lower overhead than xymov calls
// better for interactive graphics
{
  int32_t        iq;
...
//------------------------------------------------------------------------
int32_t lux_xinvertarc(ArgumentCount narg, Symbol ps[])
{
  int32_t        iq;
...
//------------------------------------------------------------------------
int32_t lux_xdrawarc(ArgumentCount narg, Symbol ps[])
