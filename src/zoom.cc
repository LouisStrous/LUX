...
void value_string(char *trgt, Pointer image, int32_t type, int32_t indx)
{
  switch (type) {
    ...
    case LUX_INT32:
      ...
      break;
    case LUX_INT64:
      sprintf(trgt, "Value:% 10jd", image.i64[indx]);
      break;
    case LUX_FLOAT:
...
int32_t lux_zoom(ArgumentCount narg, Symbol ps[])
// ZOOM,image[,bitmap]
{
                  ...
                  if (i < 8) {        // take from current image
                    ...
                    switch (type) {
                      ...
                      case LUX_INT32:
                        ...
                        break;
                      case LUX_INT64:
                        zoom_clo = (double) lastmin.i64;
                        zoom_chi = (double) lastmax.i64;
                        break;
                      case LUX_FLOAT:
...
//--------------------------------------------------------------------------
int32_t tvzoom(ArgumentCount narg, Symbol ps[])
{
