  ...
  : public CppUnit::TestFixture
{
  ...
  CPPUNIT_TEST(axis_012);
  CPPUNIT_TEST(axis_102);
  CPPUNIT_TEST(axis_201);
  CPPUNIT_TEST(axis_012_eachrow);
  CPPUNIT_TEST(axis_102_eachrow);
  CPPUNIT_TEST(axis_201_eachrow);
  CPPUNIT_TEST(edge);
  CPPUNIT_TEST(simple_args);
  CPPUNIT_TEST_SUITE_END();
public:
  void axis_012();
  void axis_102();
  void axis_201();
  void axis_012_eachrow();
  void axis_102_eachrow();
  void axis_201_eachrow();
  void edge();
  void simple_args();
};
